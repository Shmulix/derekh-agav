...
const terms = [
  ...
  },
  {
    ...
    he: "תוספת נהג צעיר",
    desc: "חיוב יומי נוסף לנהגים מתחת לגיל 25 (לפעמים 23). גובה התוספת משתנה בין חברות ההשכרה.",
  },
  {
    term: "Senior Driver",
  ...
  },
  {
    ...
    he: "שובר הזמנה",
    desc: "מסמך ההזמנה שמציגים בדלפק. מכיל את פרטי ההשכרה, מה כלול ומה לא. שמור עליו.",
  },
  {
    term: "No-Show",
    full: "No-Show Policy",
    he: "אי-הגעה",
    desc: "לא הגעת לאסוף את הרכב ולא ביטלת מראש. חברת ההשכרה תחייב דמי No-Show בדרך כלל בין 50 ל-200 דולר, בין אם הסיבה הייתה שינוי תוכנית, מסמך חסר או כל סיבה אחרת.",
  },
  {
  ...
  },
  {
    ...
    he: "ברוקר / אתר השוואה",
    desc: "חברה שמשווה מחירים ומוכרת הזמנות בשם חברות השכרה רבות. לא הם מספקים את הרכב. חברת ההשכרה מספקת.",
  },
  {
    term: "Supplier",
    full: "Car Rental Supplier",
    he: "חברת ההשכרה",
    desc: "החברה שמחזיקה בפועל את הרכבים ומנהלת את הדלפק. Hertz, Avis, Europcar הן דוגמאות לחברות השכרה.",
  },
  {
    term: "Damage Report",
  ...
  },
  {
    ...
    he: "נסיעה חוצת גבול",
    desc: "נסיעה עם הרכב למדינה אחרת. לרוב אסורה ללא אישור מראש בכתב מחברת ההשכרה. כרוכה לעיתים בתוספת תשלום.",
  },
  {
    term: "In-Terminal",
    full: "Airport In-Terminal",
    he: "בתוך הטרמינל",
    desc: "תחנת ההשכרה ממוקמת פיזית בתוך הטרמינל. נגישה ישירות, ללא שאטל וללא זמן נסיעה.",
  },
  {
    term: "Off-Airport",
  ...
  },
  {
    ...
    he: "תקן חורף אירופי",
    desc: "סימון על גבי הצמיג בדמות פתית שלג בתוך הר משולש. מעיד שהצמיג עומד בתקן הביצועים לתנאי חורף. נדרש להכרה חוקית כצמיג חורף ברוב מדינות אירופה.",
  },
  {
    term: "Snow Chains",
    full: "Snow / Tire Chains",
    he: "שרשראות שלג",
    desc: "שרשראות מתכת שמתקינים על הגלגלים לשיפור האחיזה בשלג עמוק וקרח. נדרשות בחלק מהאזורים ההרריים בנוסף לצמיגי חורף.",
  },
  {
    term: "Snow Socks",
    full: "Textile Snow Socks",
    he: "גרביוני שלג",
    desc: "גרסת הטקסטיל של שרשראות השלג: כיסויי בד שמתלבשים על הגלגל. קלים יותר להתקנה, ומוכרים חוקית באותן מדינות שמאפשרות שרשראות.",
  },
  {
    term: "Vignette",
    full: "Road Vignette / Toll Sticker",
    he: "ויניט / מדבקת כביש",
    desc: "מדבקה או אישור דיגיטלי לשימוש בכביש מהיר. חובה במדינות כמו אוסטריה, שווייץ, צ׳כיה, הונגריה ועוד. חברת ההשכרה בדרך כלל מספקת אותה, אך לנסיעה חוצת גבול צריך לבדוק.",
  },
  {
    term: "After Hours",
    full: "After Hours / Out of Hours Return",
    he: "החזרה מחוץ לשעות פעילות",
    desc: "החזרת רכב כשהתחנה סגורה. בדרך כלל מפקידים את המפתח בתיבת מפתחות ייעודית. בדוק מראש. חברת ההשכרה עשויה לשנות שעות איסוף או החזרה ולא להודיע.",
  },
  {
  ...
  },
  {
    ...
    he: "שירותי דרכים",
    desc: "שירות חירום בדרכים: פנצ׳ר, תקלת מנוע, מצבר מת. בדרך כלל כלול בהשכרה, אבל כדאי לוודא ולשמור את מספר החירום של חברת ההשכרה בטלפון.",
  },
  {
    term: "Toll Pass",
    full: "Electronic Toll Transponder / Auto-Pass",
    he: "טרנספונדר / אוטו-פס",
    desc: "מכשיר אלקטרוני המותקן ברכב ומאפשר מעבר אוטומטי בנתיבי אגרה ייעודיים ללא עצירה. חברות ההשכרה מציעות אותו לפעמים בתשלום יומי נוסף. לא כל תחנה מציעה את השירות.",
  },
  {
    term: "ZTL",
    full: "Zona a Traffico Limitato",
    he: "אזור כניסה מוגבלת (איטליה)",
    desc: "אזורים בערים איטלקיות שבהם כניסת רכבים פרטיים מוגבלת ונשלטת על ידי מצלמות. כניסה ללא אישור גוררת קנס שמגיע בדיעבד לחברת ההשכרה ומועבר אליך בתוספת דמי טיפול.",
  },
  {
    term: "Infant Seat",
    full: "Infant Car Seat",
    he: "כיסאון לתינוק",
    desc: "כיסא בטיחות לתינוקות עד כ-13 ק\"ג, פונה לאחור בלבד. לא כל התחנות מצוידות בכיסא תואם לתינוקות מתחת לגיל שנה. חובה לוודא זמינות מול חברת ההשכרה לפני ההזמנה.",
  },
  {
    term: "Baby Seat",
    full: "Baby / Toddler Car Seat",
    he: "כיסא לפעוט",
    desc: "כיסא בטיחות לילדים בין כ-9 ל-18 ק\"ג (בערך גיל 9 חודשים עד 4 שנים). יכול לפנות קדימה או אחורה לפי הדגם. תמיד בדוק תאימות לפי משקל.",
  },
  {
    term: "Child Seat",
    full: "Child Car Seat",
    he: "כיסא ילדים",
    desc: "כיסא בטיחות לילדים בין כ-15 ל-36 ק\"ג (בערך גיל 3 עד 10 שנים). פונה קדימה, מאובטח עם חגורת הרכב.",
  },
  {
    term: "Booster Seat",
    full: "Booster / Booster Cushion",
    he: "מושב הגבהה",
    desc: "מושב הגבהה לילדים מעל כ-22 ק\"ג. בלי רתמה מובנית: הילד מאובטח עם חגורת הרכב. מגביה את הילד כך שהחגורה תפגע בנקודה הנכונה.",
  },
  {
    term: "Ski Rack",
    full: "Ski Rack / Roof Rack",
    he: "גגון סקי / מנשא גג",
    desc: "מנשא המותקן על גג הרכב לקיבוע סקיות, סנובורד או מטען גדול. ניתן לשכור מחברת ההשכרה. לא כל הרכבים מגיעים מוכנים לגגון. בדוק זמינות והזמן מראש.",
  },
  {
    term: "Supplemental Coverage",
    full: "Supplemental / Third-Party Insurance / Additional Coverage",
    he: "כיסוי משלים",
    desc: "ביטוח שנרכש מחוץ לחברת ההשכרה, דרך ברוקר, סוכנות נסיעות או עצמאית. לא מונע חיוב אלא מחזיר כסף בדיעבד, תמיד עד לתקרה שנקבעה בפוליסה. יש שלושה סוגים: כיסוי השתתפות עצמית בלבד, כיסוי נזקים ייחודיים, וכיסוי משולב.",
  },
];
