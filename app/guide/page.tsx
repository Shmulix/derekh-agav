...
import {
  ...
  AlertTriangle, Info, Lightbulb, Clock, MapPin, Car, BookOpen, BookMarked, Globe, Snowflake, Receipt, Package, CalendarX, MessageCircle,
} from "lucide-react";
...
export const metadata: Metadata = {
  ...
  description:
    "מסמכים, ביטוח, פיקדון, נהג צעיר, דלק, קילומטרז׳, קנסות וביטול. כל מה שצריך לדעת לפני שמגיעים לדלפק. מניסיון אמיתי של יותר מ-10 שנים.",
  alternates: {
    canonical: "https://derekh-agav.vercel.app/guide",
  },
  openGraph: {
    title: "המדריך המלא להשכרת רכב בחו״ל | דרך אגב",
    description:
      "מסמכים, ביטוח, פיקדון, נהג צעיר, דלק, קילומטרז׳ וקנסות. כל מה שצריך לדעת לפני שמגיעים לדלפק.",
    url: "https://derekh-agav.vercel.app/guide",
    type: "article",
  },
};
...
const faqJsonLd = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "מה המסמכים שחייבים לקחת להשכרת רכב בחו״ל?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "חמישה דברים: (1) רישיון נהיגה ישראלי פיזי בפלסטיק בתוקף. (2) רישיון נהיגה בינלאומי פיזי בתוקף. (3) כרטיס אשראי בינלאומי פיזי עם מסגרת פנויה לפיקדון, קוד סודי, ולפחות 6 חודשי תוקף. (4) דרכון בתוקף. (5) כרטיס עלייה למטוס. לפעמים תבקש התחנה לראות אותו. כל המסמכים חייבים לשאת את אותו השם שמופיע בהזמנה, וכולם חייבים להיות מונפקים מאותה מדינה. שם שונה, או אחד המסמכים ממדינה שונה מרוב המסמכים? אין רכב.",
      },
    },
    {
      "@type": "Question",
      "name": "האם צריך רישיון נהיגה בינלאומי (IDP) להשכרת רכב בחו״ל?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "כן. רישיון ישראלי הוא מסמך מקומי. תקף בישראל, לא מחוצה לה. רישיון נהיגה בינלאומי (IDP, International Driving Permit) הוא זה שמאשר נהיגה בחו״ל. לא כל תחנה בודקת אותו בפועל, אבל כשמבקשים ואין, הרכב לא יינתן. לוקחים את שניהם ביחד, תמיד.",
      },
    },
    {
      "@type": "Question",
      "name": "מה זה פיקדון ברכב שכור ואיך הוא עובד?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "פיקדון הוא סכום כסף שחברת ההשכרה חוסמת זמנית בכרטיס האשראי של הלקוח בעת איסוף הרכב. הסכום לא מחויב בפועל, אלא נשמר כערבון למקרה של נזק לרכב, קנסות, דלק חסר או חריגה מתנאי ההשכרה. בסיום ההשכרה, אם הכול תקין ואין חיובים נוספים, הפיקדון משתחרר וחוזר להיות זמין בכרטיס האשראי.",
      },
    },
    {
      "@type": "Question",
      "name": "מה ההבדל בין CDW/TP לבין SCDW/STP בהשכרת רכב?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "CDW ו-TP הם כיסויים בסיסיים לנזק ולגניבה, אך כוללים השתתפות עצמית שגובהה משתנה לפי חברת ההשכרה וקטגוריית הרכב. הסכום המדויק מופיע בתנאי ההשכרה. SCDW ו-STP הם אותה הגנה בדיוק, אך ללא השתתפות עצמית.",
      },
    },
    {
      "@type": "Question",
      "name": "כמה עולה תוספת נהג צעיר בהשכרת רכב?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "אם לפי תנאי ההשכרה שלך אתה מוגדר כנהג צעיר, הנציג בדלפק יגבה תוספת יומית בעת איסוף הרכב. הסכום משתנה לפי חברת ההשכרה ומופיע בתנאי ההזמנה. בדרך כלל מדובר על 10 עד 20 אירו ליום.",
      },
    },
    {
      "@type": "Question",
      "name": "האם מותר לנסוע עם רכב שכור מארץ לארץ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "כן, אפשרי. אבל רק עם אישור בכתב מחברת ההשכרה. צריך לציין את המדינות היעד כבר בשלב ההזמנה. בנוסף, חובה להוסיף ביטוח חציית גבול (Cross Border Insurance), שמחיר ותנאיו משתנים לפי חברת ההשכרה ומפורטים בתנאי ההזמנה. לא כל המדינות מורשות ולא כל קטגוריות הרכב מאושרות. נסיעה ללא אישור מפורש עלולה לבטל את כל הביטוח.",
      },
    },
    {
      "@type": "Question",
      "name": "מה קורה אם מחזירים רכב שכור באיחור?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "לרוב חברות ההשכרה מאפשרות זמן חסד לפני שמתחיל חיוב נוסף. משך זמן החסד משתנה לפי חברת ההשכרה ומפורט בתנאי ההזמנה. מעבר לזמן החסד, התחנה תחייב יום שהייה נוסף לפי התעריף היומי שלה, ולפעמים גם קנס נוסף.",
      },
    },
    {
      "@type": "Question",
      "name": "מה זה דמי החזר (One-Way Fee) בהשכרת רכב?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "אם מחזירים את הרכב בתחנה אחרת מזו שממנה אספו אותו, ייתכן שיחויב דמי החזר (One-Way Fee). זה לא אוטומטי. תלוי בחברה, במרחק בין התחנות, ולפעמים גם בין אם מדובר באותה עיר או לא. יש מקרים שבהם אין חיוב כלל. כדאי לבדוק לפני שמסיימים את ההזמנה.",
      },
    },
    {
      "@type": "Question",
      "name": "איך פועלים כבישי אגרה ווינייטות ברכב שכור באירופה?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "ישנם שני סוגי אגרה: וינייטה (מדבקה שנרכשת מראש לגישה לרשת כבישים, נדרשת באוסטריה, שוויץ, צ׳כיה ועוד) וכביש אגרה ממוחשב (חיוב אוטומטי במצלמה). לכבישים ממוחשבים חברות ההשכרה מצמידות מכשיר Toll Pass ומחייבות תוספת שירות יומית. וינייטות לרוב כלולות ברכב.",
      },
    },
    {
      "@type": "Question",
      "name": "מה לעשות מיד אחרי תאונה עם רכב שכור?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "קודם כל: לתעד הכל לפני שמזיזים את הרכב. לצלם נזקים, לוחית רישוי הרכב האחר, ורישיון הנהג השני. למלא טופס אירועים אירופי (European Accident Statement / Constat Amiable). ליצור קשר עם חברת ההשכרה לפני שמחליטים לגרור את הרכב. לא להסכים לפשרות במזומן בשטח.",
      },
    },
    {
      "@type": "Question",
      "name": "מתי ציוד חורף הוא חובה ברכב שכור?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "צמיגי חורף הם חובה חוקית באוסטריה, שוויץ, סקנדינביה ובמדינות נוספות בחודשי החורף. בגרמניה, צרפת ואיטליה: חובה בתנאי שלג או קרח. ברוב ההשכרות החורפיות באירופה (נובמבר-מרץ) הרכב כבר מצויד בצמיגי חורף. שרשראות שלג מומלץ להחזיק באזורים הרריים.",
      },
    },
    {
      "@type": "Question",
      "name": "מה דמי ביטול בהשכרת רכב ומתי לא מחזירים כסף?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "הזמנות עם ביטול חינם ניתנות לביטול ללא עלות עד 24-48 שעות לפני האיסוף. הזמנות Non-Refundable (מחיר מוזל): אין החזר בכלל. No-Show (הגעת לתחנה ולא אספת את הרכב) גוררת חיוב מלא ברוב המקרים. חשוב לקרוא את מדיניות הביטול לפני ההזמנה ולשמור את אישור הביטול.",
      },
    },
  ],
};
...
const tocItems = [
  ...
  { id: "faq", label: "שאלות נפוצות", icon: MessageCircle },
        ...
        <div className="flex gap-8 xl:gap-12 items-start">
          ...
          <article className="flex-1 min-w-0">
            ...
            <div id="intro" className="mb-2 scroll-mt-24">
              ...
              <p className="text-gray-800 text-lg font-semibold leading-relaxed mb-5">
                לפני כל נסיעה עם רכב שכור, יש שאלות שחייבים לדעת לענות עליהן. רוב האנשים מגלים אותן בדלפק. אתה תגלה אותן כאן.
              </p>

              <p className="text-gray-700 leading-relaxed mb-4">
                המדריך הזה מכסה את כל מה שצריך לדעת לפני ששוכרים רכב בחו״ל. מסמכים נדרשים, ביטוח, פיקדון, דלק, קנסות, חציית גבולות ועוד. כל נושא מוסבר בשפה פשוטה, בלי מינוח משפטי, בלי שיווק.
              </p>
              ...
              {/* Career timeline */}
              <AccordionItem title="הדרך שעשיתי, ולמה היא רלוונטית בשבילך" icon="🪪" headerImage={{ src: author.image, alt: author.name }} headerName={author.name} headerSubtitle="מומחה השכרת רכב בינלאומית · 10 שנות ניסיון" expandLabel="קרא עוד">
                ...
                <div className="space-y-0">
                  {[
                    ...
                    },
                    {
                      ...
                      desc: "האופרציה היא הלב של כל ברוקר השכרת רכב. שם מחליטים על כל הזמנה: לאשר, לדחות, להתאים. הייתי בקשר ישיר ויומיומי עם חברות ההשכרה. לא כלקוח, כשותף עסקי. שם למדתי איך השוק הזה עובד באמת: איך חברות ההשכרה חושבות, מה מניע אותן, תחת אילו אילוצים הן פועלות ואיפה הגמישות שלהן נגמרת.",
                    },
                    {
                      role: "מנהל מוקד",
                      desc: "ניהלתי צוות שטיפל בלקוחות כל יום ושמעתי תרחישים שלא הייתי מאמין שקורים בפועל. ופגשתי שוב ושוב את אותו פער: בין מה שהלקוח חשב שהזמין לבין מה שהסכים עליו בחוזה. זה פער שמעצבן אותי עד היום.",
                    },
                    {
                      role: "מנהל שיווק שותפים",
                      desc: "ואז ראיתי את התחום מבחוץ. הבנתי איך הוא נמכר, מה אנשים מחפשים, ואיך המידע הזמין ברשת פשוט לא עונה על מה שנדרש לדעת לפני ששוכרים רכב בחו״ל.",
                    },
                  ].map((item, i, arr) => (
            ...
            <div className="lg:hidden bg-navy rounded-none p-5 mb-8">
              ...
              <p className="text-slate-300 text-xs leading-relaxed mb-3">
                המדריך הזה מבוסס על ניסיון אישי ומקרים מהשטח. הוא מדריך, לא חוזה. כל חברת השכרה קובעת את תנאיה בעצמה: סכומי פיקדון, דרישות ביטוח, גיל מינימום, רשימת מסמכים. כל אלה יכולים להיות שונים ממה שכתוב כאן.
              </p>
              <p className="text-slate-300 text-xs leading-relaxed">
                המדריך הזה נותן לך את הבסיס, את הלוגיקה, את מה שרוב האנשים לא יודעים. אבל כל חברת השכרה כותבת את החוזה שלה בעצמה. הטעות הכי נפוצה שראיתי? אנשים שמניחים שאם ידעו אחד כך, כולם כאלה. לא. תפתח את תנאי ההזמנה שלך, תקרא אותם מהתחלה עד הסוף, ותשתמש במדריך הזה כדי להבין מה שקראת.
              </p>
            </div>
            ...
            <div className="hidden lg:block bg-navy rounded-none p-6 mb-10">
              ...
              <p className="text-slate-300 text-sm leading-relaxed mb-4">
                המדריך הזה נותן לך את הבסיס, את הלוגיקה, את מה שרוב האנשים לא יודעים. אבל כל חברת השכרה כותבת את החוזה שלה בעצמה. הסכום של הפיקדון, איזה ביטוח כלול, מה קורה עם נזק לשמשה, האם יש הגבלת קילומטרז׳, מינימום גיל נהג. כל אלה משתנים מחברה לחברה, ולפעמים גם בין מדינות של אותה חברת השכרה.
              </p>
              <p className="text-slate-300 text-sm leading-relaxed">
                הטעות הכי נפוצה שראיתי? אנשים שהשכירו רכב בעבר ומניחים שהם יודעים את כל מה שנדרש לדעת. אז לא. תפתח את תנאי ההזמנה שלך, תקרא אותם מההתחלה עד הסוף (כן, עד הסוף! אתה שוכר רכב וזה עניין רציני), ותשתמש במדריך הזה כדי להבין מה שקראת. זו הצורה הנכונה להשתמש בו.
              </p>
            </div>
            ...
            <SectionIntro>
              כאן אין יצירתיות. יש כללים. חסר מסמך אחד? הדלפק לא ממציא פתרונות, הוא לא "יחרוג ממנהגו". הוא פשוט לא ייתן לך את הרכב.
            </SectionIntro>
            ...
            <Callout type="warning">
              <strong>כל המסמכים חייבים להיות מונפקים מאותה מדינה.</strong> ישראלי שמגיע עם רישיון ישראלי, דרכון ישראלי וכרטיס אשראי ישראלי? מצוין. ישראלי שמגיע עם דרכון זר, כרטיס אשראי על שם אחר, או רישיון ממדינה שלישית? הדלפק רואה חוסר התאמה, ומשם אין ויכוח.
            </Callout>
            ...
            <Callout type="tip">
              ...
              <Link href="/posts/idp-stations" className="font-semibold underline underline-offset-2 hover:opacity-75">
                איפה מנפיקים רישיון נהיגה בינלאומי בישראל: כל 66 התחנות ←
              </Link>
            </Callout>
            ...
            <AccordionItem title="התאמת שמות: הנקודה שישראלים מפספסים" icon="⚠️">
              <p className="text-sm text-gray-600 leading-relaxed mb-3">
                בישראל אנחנו אלופי עולם בלשחק עם שמות באנגלית. פעם שם נעורים, פעם קיצור, פעם איות שונה. בארץ? מסתדרים.
            ...
            <AccordionItem title="השם בהזמנה = הנהג. לא מי שמשלם, לא מי שבא לאסוף" icon="👤">
              ...
              <ul className="space-y-3 mb-4 text-sm text-gray-600">
                <li className="flex gap-2 items-start">
                  ...
                  <span><strong className="text-gray-800">נהג נוסף:</strong> אפשר להוסיף נהג נוסף בדלפק בזמן האיסוף. הוא חייב להיות נוכח פיזית, עם רישיון ישראלי ורישיון בינלאומי (IDP) בתוקף. זה כרוך בתוספת תשלום יומית.</span>
                </li>
                <li className="flex gap-2 items-start">
                  <span className="font-bold text-navy flex-shrink-0">2.</span>
                  <span><strong className="text-gray-800">נהג ראשי אחר:</strong> אם מישהו אחר הוא הנהג הראשי, שמו צריך להיות בהזמנה, כרטיס האשראי על שמו, וכל המסמכים שלו. שינוי שם לאחר ההזמנה יכול לאפס אותה לחלוטין.</span>
                </li>
              </ul>
            ...
            <SectionIntro>
              פיקדון הוא סכום כסף שחברת ההשכרה חוסמת זמנית בכרטיס האשראי שלך בעת איסוף הרכב. הסכום לא מחויב בפועל, אלא נשמר כערבון למקרה של נזק לרכב, קנסות, דלק חסר או חריגה מתנאי ההשכרה. בסיום ההשכרה, אם הכול תקין ואין חיובים נוספים, הפיקדון משתחרר וחוזר להיות זמין בכרטיס האשראי.
            </SectionIntro>
              ...
              <div className="space-y-3 text-sm text-gray-600 leading-relaxed">
                ...
                <div className="flex gap-3 bg-yellow-50 border border-yellow-200 rounded-none p-3">
                  ...
                  <div>
                    ...
                    <p>אם בגלל חוסר הרכב נגרמו לך הוצאות נוספות, כמו הסדר חלופי, נסיעות או לינה, שמור את כל הקבלות. אפשר לתבוע פיצוי על ההוצאות האלה, לעיתים גם דרך הברוקר שדרכו הזמנת.</p>
                  </div>
                </div>
              </div>
            </AccordionItem>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <p className="font-bold text-orange-700 text-sm">לא מכוסה בביטוח הבסיסי</p>
                  </div>
            ...
            <AccordionItem title="נהג צעיר: מה זה אומר בפועל" icon="🟡" defaultOpen={false}>
              <p className="text-sm text-gray-600 leading-relaxed mb-3">
                ברוב החברות אפשר לשכור מגיל 21. אבל עד גיל מסוים, חברת ההשכרה מגדירה אותך כ"נהג צעיר" ומוסיפה תוספת יומית. הגבול הזה משתנה: חלק עוצרים ב-23, חלק ב-25, יש שמגיעים ל-26. ברכבי פרימיום, לעיתים גיל המינימום עצמו עולה.
              </p>
            ...
            <AccordionItem title="נהג בכיר: מה שרוב האנשים לא בודקים" icon="🔵" defaultOpen={false}>
              <p className="text-sm text-gray-600 leading-relaxed mb-3">
                זה לא נפוץ, ופחות ופחות חברות השכרה מיישמות את זה בפועל. אבל זה עדיין קיים אצל חלק מהן, בעיקר ביעדים מסוימים. הגבול המקובל הוא גיל <strong className="text-navy">70</strong>, אבל יש חברות השכרה שמגדירות אותו גבוה יותר. אם אתה בטווח הזה, כדאי לבדוק את מדיניות חברת ההשכרה לפני שמזמינים.
              </p>
              ...
              <div className="bg-gray-50 border border-[#e7e9f0] rounded-none p-3 text-xs text-gray-600 leading-relaxed">
                גיל מקסימום ברוב חברות ההשכרה הוא בין <strong className="text-navy">80 ל-85</strong>. מעבר לכך, ברוב המקרים ההשכרה לא אפשרית. לפני שמזמינים, תבדוק את המדיניות של חברת ההשכרה הספציפית.
              </div>
            </AccordionItem>
            ...
            <AccordionItem title="שעת האיסוף: מה מותר, מה מסוכן" icon="🕐">
              <div className="space-y-3 text-sm text-gray-600 leading-relaxed">
                ...
                <div className="flex gap-3">
                  <span className="text-lg flex-shrink-0">✈️</span>
                  <p><strong className="text-gray-800">איסוף בשדה עם מספר טיסה.</strong> חברת ההשכרה עוקבת אחרי לוח הטיסות ומתאימה את עצמה. איחור? הם רואים את זה ומחכים. תמיד תציין מספר טיסה. זה לא פרט אופציונלי.</p>
                </div>
            ...
            <AccordionItem title="החזרה במקום אחר: דמי החזרה (One-Way Fee)" icon="↩️">
              <div className="space-y-3 text-sm text-gray-600 leading-relaxed">
                <p>
                  רוצה לאסוף את הרכב בפריז ולהחזיר ברומא? זה אפשרי. זה נקרא <strong className="text-navy">השכרה חד-כיוונית (One-Way)</strong>, ויש לה מחיר.
                </p>
                <p>
            ...
            <SectionIntro>
              לא כל כביש מהיר חינמי. חלק מהמדינות גובות תשלום ישיר בכניסה לכביש, חלק דורשות מכשיר אלקטרוני ברכב, וחלק פועלות עם תו תקופתי שנרכש מראש. תבדוק איזה מנגנון פועל במדינה שאתה נוסע אליה, לפני שיוצאים לדרך.
            </SectionIntro>
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="bg-surface border border-[#e7e9f0] rounded-none p-4">
                <p className="text-sm font-bold text-navy mb-1">📡 טרנספונדר / אוטו-פס</p>
                ...
                <Callout type="warning">
                  אם עברת בנתיב מהיר <strong>בלי טרנספונדר</strong>, האגרה תגיע לחברת ההשכרה בדיעבד. תחויב על האגרה עצמה <strong>ועוד דמי טיפול</strong> שיכולים להגיע לכמה עשרות יורו לכל מעבר. ודא שיש לך פתרון מתאים לפני שנכנסים לנתיב הלא נכון.
                </Callout>
              </div>
              ...
              <div className="bg-surface border border-[#e7e9f0] rounded-none p-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  <div className="bg-green-50 border border-green-200 rounded-none p-3">
                    <p className="font-bold text-green-700 mb-1">כששוכרים במדינה שדורשת ויניט</p>
            ...
            <div className="bg-surface border border-[#e7e9f0] rounded-none p-5 mb-5 text-sm text-gray-700 leading-relaxed space-y-3">
              ...
              <p>
                הדבר הנכון לעשות: <strong className="text-navy">להצהיר על הנסיעה כבר בשלב ההזמנה</strong>. ברוב אתרי ההשוואה ואצל רוב חברות ההשכרה יש שדה ייעודי לכך. אם אין, פנה ישירות לחברת ההשכרה ותקבל אישור בכתב. ייתכן תשלום נוסף עבור ביטוח לנסיעה מחוץ לגבולות. זה משתנה בין חברות ההשכרה, אז תבדוק בתנאי ההשכרה.
              </p>
            </div>

            <Callout type="tip">
              <strong>חשוב לציין את היציאה כבר בשלב ההזמנה.</strong> לא כל הרכבים מורשים לנסיעה מחוץ למדינת ההשכרה. כשמסמנים את המדינות היעד בעת ההזמנה, התוצאות מסוננות אוטומטית לרכבים מורשים בלבד. רכב שלא הוצהר עליו מראש, גם אם כבר נלקח, עלול שלא לקבל אישור בפועל.
            </Callout>
            ...
            <AccordionItem title="ויניט (Vignette): כשנוסעים למדינה אחרת" icon="🪟">
              <p className="text-sm text-gray-600 leading-relaxed">
                כששוכרים רכב במדינה שדורשת ויניט, הוא כלול בדרך כלל בהשכרה. כשנוסעים ממדינה אחרת לתוכה, האחריות עליך. לא בדקת, לא שילמת? קנס. פרטים מלאים על ויניט ואוטו-פס בסעיף כבישי אגרה למעלה.
              </p>
            </AccordionItem>
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="bg-red-50 border border-red-200 rounded-none p-4">
                ...
                <p className="text-sm text-gray-600 leading-relaxed mb-2">
                  לתינוקות עד כ-13 ק"ג (בערך עד גיל שנה). פונה לאחור בלבד.
                </p>
              ...
              <div className="bg-surface border border-[#e7e9f0] rounded-none p-4">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  לילדים בין כ-15 ל-36 ק"ג (בערך גיל 3 עד 10 שנים). פונה קדימה, עם חגורת בטיחות של הרכב. מתאים לילדים שיצאו מכיסא עם ריתמה.
                </p>
              </div>
              ...
              <div className="bg-surface border border-[#e7e9f0] rounded-none p-4">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  לילדים מעל כ-22 ק"ג (בערך גיל 6 ומעלה). מגביה את הילד כך שחגורת הרכב תפגע בנקודה הנכונה. אין ריתמה, הילד כבר מאובטח עם חגורת הרכב עצמה.
                </p>
              </div>
            ...
            <Callout type="tip">
              מזמינים מראש? הזמינות גבוהה יותר ומחיר זהה. מחכים לרגע האחרון? אפשרי, אבל בעונות שיא הציוד עשוי להיגמר. ועם כיסא בטיחות לתינוק, בכלל לא לוקחים סיכון.
            </Callout>
            ...
            <div className="bg-surface rounded-none p-5 mb-5 border border-[#e7e9f0]">
              ...
              <div className="space-y-1">
                ...
                <FineStep num={3} text="חברת ההשכרה גובה דמי טיפול מנהליים: 20 עד 50 יורו לדוח. גם אם אתה מתכנן לערער." />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-5">
              <div className="bg-green-50 border border-green-200 rounded-none p-4">
                ...
                <p className="text-xs text-gray-600 leading-relaxed">
                  ברוב המקרים ללא עלות, או עם דמי ביטול סמליים בלבד. חלק מהחברות מחזירות את מלוא הסכום ללא שאלות.
                </p>
              </div>
            ...
            <div className="bg-red-50 border border-red-200 rounded-none p-4 mb-5">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">
                חשוב: גם אם הסיבה לאי-ההגעה הייתה מחוץ לשליטתך, החיוב מבוסס על התנאים שאישרת בהזמנה ולא על הנסיבות.
              </p>
            </div>

            <Callout type="tip">
              לפני שמאשרים הזמנה: בדוק את מדיניות הביטול וה-No-Show בתנאים. זו שורה אחת שיכולה לחסוך לך עד 200 דולר.
            </Callout>
                ...
                <div className="space-y-3 text-sm text-gray-600 leading-relaxed">
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      { step: "2", title: "חברת ההשכרה / שירות הדרכים", text: "פנה לתחנה או לשירות הדרכים לקבלת הוראות מדויקות. הם יקבעו אם שולחים גרר, נותנים רכב חלופי, או שאפשר להמשיך בנסיעה." },
              ...
              {[
                {
                  ...
                  a: "חמישה דברים שצריך להביא: (1) רישיון נהיגה ישראלי פיזי בפלסטיק, בתוקף. (2) רישיון נהיגה בינלאומי פיזי, בתוקף. (3) כרטיס אשראי בינלאומי פיזי עם מסגרת פנויה מספקת לפיקדון, עם קוד סודי, ועם לפחות 6 חודשי תוקף. (4) דרכון בתוקף. (5) לפעמים תבקש התחנה לראות גם כרטיס עלייה למטוס. שני דברים קריטיים: כל המסמכים חייבים לשאת את אותו השם שמופיע בהזמנה, וכולם חייבים להיות מונפקים מאותה מדינה. שם שונה, או אחד המסמכים ממדינה שונה מרוב המסמכים? אין רכב.",
                },
                {
                  q: "האם צריך רישיון נהיגה בינלאומי (IDP)?",
                  a: "כן. רישיון ישראלי הוא מסמך מקומי. תקף בישראל, ולא נועד לנהיגה בחו״ל. רישיון נהיגה בינלאומי (International Driving Permit, בקיצור IDP) הוא זה שמאשר את הזכות לנהוג מחוץ למדינה. נכון שלא כל תחנה בודקת אותו בפועל, אבל כשמבקשים אותו ואין אותו, הרכב לא יינתן. זה קורה, ולא לעיתים נדירות. לוקחים את שניהם ביחד, תמיד.",
                },
                {
                  q: "מה זה פיקדון ואיך הוא עובד?",
                  a: "פיקדון הוא סכום כסף שחברת ההשכרה חוסמת זמנית בכרטיס האשראי של הלקוח בעת איסוף הרכב. הסכום לא מחויב בפועל, אלא נשמר כערבון למקרה של נזק לרכב, קנסות, דלק חסר או חריגה מתנאי ההשכרה. בסיום ההשכרה, אם הכול תקין ואין חיובים נוספים, הפיקדון משתחרר וחוזר להיות זמין בכרטיס האשראי.",
                },
                {
                  q: "מה ההבדל בין CDW/TP לבין SCDW/STP?",
                  a: "CDW ו-TP הם כיסויים בסיסיים לנזק ולגניבה, אך כוללים השתתפות עצמית שגובהה משתנה לפי חברת ההשכרה וקטגוריית הרכב. הסכום המדויק מופיע בתנאי ההשכרה. SCDW ו-STP הם אותה הגנה בדיוק, אך ללא השתתפות עצמית.",
                },
                {
                  q: "כמה עולה תוספת נהג צעיר?",
                  a: "אם לפי תנאי ההשכרה שלך אתה מוגדר כנהג צעיר, הנציג בדלפק יגבה תוספת יומית בעת איסוף הרכב. הסכום משתנה לפי חברת ההשכרה ומופיע בתנאי ההזמנה.",
                },
                {
                  q: "האם מותר לנסוע עם רכב שכור מארץ לארץ?",
                  a: "כן, אפשרי. אבל רק עם אישור בכתב מחברת ההשכרה. צריך לציין את המדינות היעד כבר בשלב ההזמנה כדי לקבל את האישור המתאים. בנוסף, חובה להוסיף ביטוח חציית גבול (Cross Border Insurance), שמחיר ותנאיו משתנים לפי חברת ההשכרה ומפורטים בתנאי ההזמנה. לא כל המדינות מורשות ולא כל קטגוריות הרכב מאושרות לחציית גבול. נסיעה ללא אישור מפורש עלולה לבטל את כל הביטוח.",
                },
                {
                  q: "מה קורה אם מחזירים רכב באיחור?",
                  a: "לרוב חברות ההשכרה מאפשרות זמן חסד (grace period) לפני שמתחיל חיוב נוסף. משך זמן החסד משתנה לפי חברת ההשכרה ומפורט בתנאי ההזמנה, כדאי לבדוק לפני. מעבר לזמן החסד, התחנה תחייב יום נוסף לפי התעריף היומי שלה, ולפעמים גם קנס על גביו.",
                },
                {
                  q: "מה זה דמי החזר (One-Way Fee)?",
                  a: "אם אתה מחזיר את הרכב בתחנה אחרת מזו שממנה אספת אותו, ייתכן שתחויב בדמי החזר (One-Way Fee). זה לא אוטומטי. תלוי בחברה, במרחק בין התחנות, ולפעמים גם בין אם מדובר באותה עיר או לא. יש מקרים שבהם אין חיוב כלל. כדאי לבדוק את זה לפני שמסיימים את ההזמנה.",
                },
                {
                  q: "איך פועלים כבישי אגרה ווינייטות ברכב שכור?",
                  a: "ישנם שני סוגי אגרה: וינייטה (מדבקה לגישה לרשת כבישים, נדרשת באוסטריה, שוויץ, צ׳כיה ועוד) וכביש אגרה ממוחשב (חיוב אוטומטי במצלמה). לכבישים ממוחשבים חברות ההשכרה מצמידות מכשיר Toll Pass בתוספת עמלת שירות יומית.",
                },
                {
                  q: "מה לעשות מיד אחרי תאונה עם רכב שכור?",
                  a: "לתעד הכל לפני שמזיזים את הרכב: לצלם נזקים, לוחית רישוי הרכב האחר, ורישיון הנהג. למלא טופס אירועים אירופי (Constat Amiable). ליצור קשר עם חברת ההשכרה לפני שמחליטים לגרור. לא להסכים לפשרות במזומן בשטח.",
                },
                {
                  q: "מתי ציוד חורף הוא חובה?",
                  a: "צמיגי חורף הם חובה חוקית באוסטריה, שוויץ, סקנדינביה ועוד. בגרמניה, צרפת ואיטליה: חובה בתנאי שלג או קרח. ברוב ההשכרות החורפיות באירופה (נובמבר–מרץ) הרכב כבר מצויד בצמיגי חורף.",
                },
                {
                  q: "מה דמי ביטול ומתי לא מחזירים כסף?",
                  a: "הזמנות עם ביטול חינם ניתנות לביטול עד 24–48 שעות לפני האיסוף. הזמנות Non-Refundable: אין החזר. No-Show (לא אספת את הרכב) גוררת חיוב מלא. תמיד לקרוא את מדיניות הביטול לפני ההזמנה.",
                },
              ].map((item, i, arr) => (
                <AccordionItem key={i} title={item.q} expandLabel="הצג תשובה">
            ...
            <div className="p-6 bg-navy rounded-none text-center mt-10">
              ...
              <p className="text-slate-300 text-sm mb-3 leading-relaxed">
                אם הגעת עד כאן, כנראה שהמדריך שווה לך משהו. הדרך הכי טובה לתמוך בתוכן כזה? פשוט תזמין דרך הקישורים שלמטה. אותו מחיר, לפעמים אפילו יותר זול, אותן חברות ההשכרה המוכרות, רק שאני מקבל עמלה קטנה שמאפשרת לי להמשיך לכתוב. עסקה הוגנת.
              </p>
          ...
          <aside className="hidden lg:block w-56 flex-shrink-0 sticky top-24 space-y-4">
            <div className="p-4 bg-white border border-[#e7e9f0] rounded-none">
              ...
              {author.showStory && <a href="#intro" className="text-xs text-navy font-semibold hover:underline">קרא עלי ←</a>}
            </div>
