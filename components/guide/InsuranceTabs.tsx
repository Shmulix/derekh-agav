...
const neverCovered = [
  ...
  { item: "רשלנות מוכחת", note: "נזק שנגרם בזדון או בחוסר זהירות" },
    ...
    <div className="my-6">
      ...
      <div id={`insurance-panel-${active}`} role="tabpanel" className="bg-white border border-[#e7e9f0] rounded-b-lg rounded-tl-none p-5">
        ...
        {active === "supplemental" && (
          <div>
            <p className="text-sm text-gray-600 mb-4 leading-relaxed">
              כיסוי שנרכש דרך ברוקר, סוכנות נסיעות או עצמאית. לא מונע חיוב, אלא <strong>מחזיר כסף בדיעבד</strong>. תמיד עד לתקרה שנקבעה בפוליסה (בדרך כלל 2,000–3,000 יורו או דולר). לא כל כיסוי משלים זהה. בדוק מה הפוליסה שלך כוללת לפני שאתה רוכש.
            </p>
