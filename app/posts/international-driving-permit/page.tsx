          ...
          <div className="lg:grid lg:grid-cols-[220px_1fr_190px] lg:gap-10 items-start">
            ...
            <article className="min-w-0">
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-4">
                ...
                זה לא רישיון עצמאי ולא מחליף את הרישיון הישראלי. זה תרגום רשמי של הרישיון שלך למספר שפות בינלאומיות, מוכר בינלאומית, ומאפשר לרשויות ולחברות השכרה בכל מקום בעולם לאמת את פרטי הנהג, גם אם הם לא קוראים עברית.
              </p>
              <p className="text-base text-gray-700 leading-relaxed mb-4">
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-5">
                מה שאני יכול לספר הוא לא "באיזו מדינה צריך" ו"באיזו מדינה לא צריך." אין כזה דבר. מה שיש זה תדירות: באיזה יעד IDP נדרש לעיתים קרובות, ובאיזה יעד זה קורה לעיתים רחוקות. שני הדברים האלה הם לא אותו הדבר.
              </p>
