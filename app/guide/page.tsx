  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "חמישה דברים: (1) רישיון נהיגה ישראלי פיזי בפלסטיק בתוקף. (2) רישיון נהיגה בינלאומי פיזי בתוקף. (3) כרטיס אשראי בינלאומי פיזי עם מסגרת פנויה מספקת לפיקדון, עם קוד סודי, ועם לפחות 6 חודשי תוקף. (4) דרכון בתוקף. (5) כרטיס עלייה למטוס — לפעמים תבקש התחנה לראות אותו. כל המסמכים חייבים להיות על אותו השם שמופיע בהזמנה ומאותה מדינה שבה בוצעה ההזמנה.",
      },
    },
    {
      "@type": "Question",
              ...
              {[
                {
                  ...
                  a: "חמישה דברים שצריך להביא: (1) רישיון נהיגה ישראלי פיזי בפלסטיק, בתוקף. (2) רישיון נהיגה בינלאומי פיזי, בתוקף. (3) כרטיס אשראי בינלאומי פיזי עם מסגרת פנויה מספקת לפיקדון, עם קוד סודי, ועם לפחות 6 חודשי תוקף. (4) דרכון בתוקף. (5) לפעמים תבקש התחנה לראות גם כרטיס עלייה למטוס. כל המסמכים חייבים להיות על אותו השם שמופיע בהזמנה, ומאותה מדינה שבה בוצעה ההזמנה. שם שונה או דרכון של מדינה אחרת? אין רכב.",
                },
                {
