          ...
          <div className="lg:grid lg:grid-cols-[220px_1fr_190px] lg:gap-10 items-start">
            ...
            <article className="min-w-0">
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-4">
                ...
                זה לא רישיון עצמאי ולא מחליף את הרישיון הישראלי. זה תרגום רשמי של הרישיון שלך למספר שפות, שמאפשר לרשויות ולחברות ההשכרה בכל מקום בעולם לאמת את פרטי הנהג, גם אם אף אחד שם לא קורא עברית.
              </p>
              <p className="text-base text-gray-700 leading-relaxed mb-4">
                הבסיס המשפטי שלו הוא שתי אמנות בינלאומיות: אמנת ז׳נבה משנת 1949 ואמנת וינה משנת 1968. שתיהן קובעות שכל נהג שנוהג מחוץ למדינתו חייב לשאת רישיון נהיגה בינלאומי יחד עם הרישיון המקומי שלו.
                ישראל חתומה על שתיהן. כלומר, לפי הדין הבינלאומי, כל ישראלי שנוהג בחו״ל חייב להחזיק רישיון נהיגה בינלאומי. לא מומלץ. חייב.
              </p>

              <div className="border border-red-200 bg-red-50 rounded-none p-5 mb-8">
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-4">
                הרישיון הישראלי כתוב בעברית ובאנגלית. הוא עומד בתקן האירופאי. חברות ההשכרה ברחבי אירופה מכירות אותו. כל זה נכון. אבל זה שמכירים אותו לא אומר שהוא מספיק לבד.
              </p>
              ...
              <div className="border border-amber-200 bg-amber-50 rounded-none p-5 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-700 leading-relaxed">
                      עמידה בתקן אירופאי אומרת שהפורמט סטנדרטי ומוכר לקריאה. היא לא אומרת שהרישיון הישראלי מחליף את רישיון הנהיגה הבינלאומי. אלה שני מסמכים נפרדים, וצריך את שניהם.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-5">
                ...
                אבל כל הסיבות האלה קשורות לפקיד הספציפי שעמד מולך. אף אחת מהן לא אומרת שהחובה ירדה ממך.
              </p>

              <div className="bg-navy rounded-none p-6 mb-8">
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-8">
                ועוד דבר: הדלפק הוא לא הנקודה היחידה שבה יבקשו ממך את רישיון הנהיגה הבינלאומי.
                יש גם את הכביש.
              </p>
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-5">
                גם אם עברת את דלפק התחנה בלי בעיה, זה לא גמר. יש שלושה מצבים שבהם היעדר רישיון הנהיגה הבינלאומי יכול לעלות לך ביוקר.
              </p>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="border border-amber-300 bg-amber-50 rounded-none p-5">
              ...
              <div className="flex items-start gap-4 border border-navy/20 bg-[#f0f4ff] rounded-none p-5 mb-8">
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-5">
                אז מה כן אפשר לומר? לא "איפה צריך ואיפה לא". אין חלוקה כזאת. יש תדירות: יעדים שבהם מבקשים IDP לעיתים קרובות, ויעדים שבהם זה קורה לעיתים רחוקות.
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                <div className="border border-[#e7e9f0] rounded-none p-5 bg-white">
                  <p className="font-bold text-navy text-sm mb-3">נדרש לעיתים, לא שיטתי</p>
                  <p className="text-xs text-gray-500 leading-relaxed mb-3">
                    ארה״ב, קנדה, בריטניה, ורוב מדינות אירופה: צרפת, גרמניה, ספרד, איטליה, יוון, פורטוגל, טורקיה ועוד.
                  </p>
                  <p className="text-xs text-gray-600 leading-relaxed">
                    במדינות אלה רוב ישראלים מקבלים רכב בלי שנשאלים על IDP. אבל "רוב הזמן" הוא לא "תמיד."
                  </p>
                </div>
                <div className="border border-red-200 rounded-none p-5 bg-red-50">
                  <p className="font-bold text-red-800 text-sm mb-3">נדרש לעיתים קרובות, כמעט שיטתי</p>
                  <p className="text-xs text-red-700 leading-relaxed mb-3">
                    תאילנד, איחוד האמירויות, יפן.
                  </p>
                  <p className="text-xs text-red-700 leading-relaxed">
                    במדינות אלה הדרישה ל-IDP נפוצה מאוד. בתאילנד זה כמעט שיטתי לחלוטין.
                  </p>
                </div>
              </div>

              <div className="border border-amber-300 bg-amber-50 rounded-none p-5 mb-8">
                <div className="flex items-start gap-3">
                  <AlertTriangle size={18} className="text-amber-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="font-bold text-amber-900 mb-2">הנתון הזה הוא תדירות. הוא לא פטור.</p>
                    <p className="text-sm text-amber-800 leading-relaxed">
                      גם בארה״ב, גם בצרפת, גם בגרמניה, ראיתי מקרים שבהם הנציג בדלפק דרש IDP. הפקיד שעומד מולך עובד לפי הנוהל הפנימי שלו, לא לפי הסטטיסטיקה. אין לך שליטה על מה שהוא יבקש. יש לך שליטה על זה שתבוא עם IDP ולא תצטרך לדאוג לזה.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 border border-navy/20 bg-[#f0f4ff] rounded-none p-5 mb-8">
                <Info size={20} className="text-navy flex-shrink-0 mt-0.5" />
                <p className="text-sm text-gray-700 leading-relaxed">
                  אתה יוצא מישראל לנהוג על רכב שכור? לך תוציא רישיון נהיגה בינלאומי. עשרה שקלים, רבע שעה, וכל הסיפור הזה יורד לך מהראש.
                </p>
              </div>
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-4">
                ...
                לפני נסיעה ארוכה, בדוק את התוקף של שניהם.
              </p>

              <div className="border border-[#e7e9f0] rounded-none p-5 bg-surface mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                ...
                <div className="border border-navy/30 rounded-none p-4 bg-[#f0f4ff]">
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-5">
                ישראל חתומה על שתי האמנות. הרישיון הבינלאומי הישראלי תקף לפי שתי האמנות ומוכר ברוב מדינות העולם. ברוב היעדים אין שום בעיה. חוץ מיעד אחד: יפן.
              </p>
              ...
              <div className="border border-amber-200 bg-amber-50 rounded-none p-5 mb-5">
                <div className="flex items-start gap-3">
                  <AlertTriangle size={18} className="text-amber-600 flex-shrink-0 mt-0.5" />
                  <div>
              ...
              <div className="flex items-start gap-4 border border-navy/20 bg-[#f0f4ff] rounded-none p-5 mb-8">
                <Info size={20} className="text-navy flex-shrink-0 mt-0.5" />
                <p className="text-sm text-gray-700 leading-relaxed">
                  לא צריך לעשות שום דבר מיוחד בתחנת ההנפקה. הרישיון הבינלאומי הישראלי הרגיל תקף ביפן. רק ודאו שלא עברה שנה מיום ההנפקה שלו ביום הנחיתה.
                </p>
              </div>
              ...
              <div className="space-y-3 mb-6">
                {[
                  ...
                  <div key={step.num} className="flex items-start gap-4 border border-[#e7e9f0] rounded-none p-4 bg-white">
              ...
              <div className="border border-red-200 bg-red-50 rounded-none p-5 mb-6">
                <div className="flex items-start gap-3">
                  <AlertTriangle size={18} className="text-red-600 flex-shrink-0 mt-0.5" />
                  <div>
                    ...
                    <p className="text-sm text-red-700 leading-relaxed mb-2">
                      מה שמוכרים אונליין תחת השם "International Driving Permit", כלומר קובצי PDF להדפסה, אפליקציות וכרטיסים דיגיטליים, הם מסמכים ללא כל תוקף חוקי. חברות ההשכרה יסרבו לקבל אותם. המשטרה לא תכיר בהם.
                    </p>
              ...
              {/* High season note */}
              <div className="border border-amber-200 bg-amber-50 rounded-none p-4 mb-6 flex items-start gap-3">
              ...
              <div className="bg-[#f0f4ff] border border-navy/20 rounded-none p-5 mb-6 flex items-start gap-3">
              ...
              <div className="border border-amber-200 bg-amber-50 rounded-none p-5 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-700 leading-relaxed">
                      רישיון הנהיגה הבינלאומי מוציאים רק בישראל, לפני הנסיעה. אם שכחת ונזכרת יום לפני הטיסה, יש תחנות שפתוחות בשעות הבוקר המוקדמות ואפשר עדיין להספיק. ביום הטיסה עצמו, כבר מאוחר מדי.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div id="stations" className="scroll-mt-24 border border-orange-200 bg-orange-50 rounded-none p-5 mb-8 flex items-center justify-between gap-4">
                <div>
                ...
                <Link
                  href="/posts/idp-stations"
                  className="flex-shrink-0 bg-navy text-white text-sm font-bold px-4 py-2.5 rounded-none hover:bg-navy/90 transition-colors whitespace-nowrap"
                >
                  לרשימה המלאה ←
                </Link>
              </div>
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-5">
                רישיון הנהיגה הבינלאומי הוא חוברת קטנה בפורמט A6. הכריכה מודפסת בכמה שפות, כולל שם המדינה המנפיקה.
              ...
              <script
                ...
                dangerouslySetInnerHTML={{ __html: JSON.stringify({
                  ...
                  "mainEntity": [
                    ...
                    { "@type": "Question", "name": "האם צריך רישיון נהיגה בינלאומי בארה״ב?", "acceptedAnswer": { "@type": "Answer", "text": "ארה״ב היא אחת המדינות שבהן IDP לא נדרש בצורה שיטתית. רוב הישראלים מקבלים שם רכב בלי שנשאלים. אבל יש מקרים שבהם הדלפק דרש אותו. זה נתון תדירות, לא פטור. IDP עולה עשרה שקלים ומוריד את הסיכון לאפס." } },
                    { "@type": "Question", "name": "האם צריך רישיון נהיגה בינלאומי באיטליה?", "acceptedAnswer": { "@type": "Answer", "text": "איטליה נמצאת בין המדינות שבהן הדרישה אינה שיטתית, אבל יש מקרים. ההסכם הדו-צדדי שהיה עם ישראל בוטל. לא תמיד שואלים, אבל כשהם שואלים ואין, הרכב לא יוצא." } },
                    { "@type": "Question", "name": "האם צריך רישיון נהיגה בינלאומי בתאילנד?", "acceptedAnswer": { "@type": "Answer", "text": "תאילנד שונה: הדרישה שם כמעט שיטתית. חברות ההשכרה בתאילנד דורשות IDP בצורה עקבית. זה לא 'לפעמים'. זה כמעט תמיד. בלי IDP אין רכב." } },
                    { "@type": "Question", "name": "האם צריך רישיון נהיגה בינלאומי בדובאי?", "acceptedAnswer": { "@type": "Answer", "text": "באיחוד האמירויות IDP נדרש בתדירות גבוהה. חברות ההשכרה שם מיישמות את זה בצורה עקבית יותר מאשר במרבית אירופה. לא כדאי לסכן את זה." } },
                  ]
                })}}
              />
              <div className="space-y-3 mb-10">
                {[
                  ...
                  { q: "האם צריך רישיון נהיגה בינלאומי בארה״ב?", a: "ארה״ב היא אחת המדינות שבהן IDP לא נדרש בצורה שיטתית. רוב הישראלים מקבלים שם רכב בלי שנשאלים. אבל ראיתי מקרים שבהם הדלפק דרש אותו. זה נתון תדירות, לא פטור. IDP עולה עשרה שקלים, לוקח רבע שעה, ומוריד את הסיכון לאפס." },
                  { q: "האם צריך רישיון נהיגה בינלאומי באיטליה?", a: "איטליה נמצאת בין המדינות שבהן הדרישה אינה שיטתית, אבל יש מקרים. ההסכם הדו-צדדי שהיה עם ישראל בוטל. לא תמיד שואלים, אבל כשהם שואלים ואין, הרכב לא יוצא." },
                  { q: "האם צריך רישיון נהיגה בינלאומי בתאילנד?", a: "תאילנד שונה: הדרישה שם כמעט שיטתית. חברות ההשכרה בתאילנד דורשות IDP בצורה עקבית. זה לא ״לפעמים״. זה כמעט תמיד. בלי IDP אין רכב." },
                  { q: "האם צריך רישיון נהיגה בינלאומי בדובאי?", a: "באיחוד האמירויות IDP נדרש בתדירות גבוהה. חברות ההשכרה שם מיישמות את זה בצורה עקבית יותר מאשר במרבית אירופה. לא כדאי לסכן את זה." },
                ].map((item, i) => (
                  <div key={i} className="border border-[#e7e9f0] rounded-none overflow-hidden">
              ...
              <div className="space-y-3 mb-10">
                ...
                <Link
                  href="/posts/idp-stations"
                  className="block bg-navy rounded-none p-5 hover:bg-navy/90 transition-colors"
                >
