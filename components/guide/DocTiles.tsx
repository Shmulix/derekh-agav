...
const docs = [
  ...
  },
  {
    ...
    text: "רישיון נהיגה בינלאומי — International Driving Permit, או בקיצור IDP — הוא המסמך שמאשר את זכות הנהיגה שלך מחוץ לישראל. נכון ש-70% מהפעמים לא מבקשים אותו. אבל ה-30% האחרים אלה בדיוק הרגעים שבהם אתה עומד בדלפק אחרי טיסה ארוכה, עם מזוודות, ומחכה לרכב שלך. לא הזמן לגלות. ה-IDP מוציאים בנקודות מורשות של משרד התחבורה, לא בדואר. תכנן את זה לפני הנסיעה.",
