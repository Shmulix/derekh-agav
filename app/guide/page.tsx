...
const faqJsonLd = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "חברת ההשכרה חוסמת סכום על כרטיס האשראי שלך (בין 300 ל-3,000 אירו בהתאם לרכב ולביטוח) כבטוחה לנזקים אפשריים. הסכום לא נגבה, רק מוחזק. הוא משוחרר לאחר החזרת הרכב תקין, בדרך כלל תוך 7-21 ימים. חשוב: נדרש כרטיס אשראי ולא דביט או פרי-פייד.",
      },
    },
    {
      "@type": "Question",
      "name": "מה ההבדל בין CDW ל-SCDW בהשכרת רכב?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "CDW (Collision Damage Waiver) הוא ביטוח נזק בסיסי שמגיע עם רוב הרכבים. הוא מכסה נזקים לגוף הרכב, אך מגיע עם השתתפות עצמית גבוהה, לרוב 500 עד 3,000 אירו. SCDW (Super CDW) מוריד את ההשתתפות העצמית לאפס. בלי SCDW כל נזק, גם קטן, עלול לעלות אלפי אירו.",
      },
    },
    {
      "@type": "Question",
      "name": "האם ביטוח כרטיס אשראי מכסה נזקים לרכב שכור?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "חלק מכרטיסי פרמיום מספקים כיסוי משלים לרכב שכור, אך התנאים מוגבלים מאוד. הכיסוי לרוב משני (פועל רק אחרי CDW), לא כולל גנבה בכל המקרים, ויש הגבלות על סוג הרכב ומשך ההשכרה. חובה לקרוא את תנאי הכרטיס הספציפי לפני שסומכים עליו.",
      },
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "נהגים מתחת לגיל 25 (ולפעמים עד 26-27 בהתאם לחברה) מחויבים בתוספת יומית של 10 עד 25 אירו ליום. התוספת מחושבת על כל ימי ההשכרה ומשולמת בדלפק בעת האיסוף, לא בהזמנה המקוונת. על 10 ימים מדובר ב-100 עד 250 אירו נוספים.",
      },
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "תלוי בחוזה ובחברת ההשכרה. ברוב ההשכרות באירופה יש הגבלות על חציית גבולות. חלק מהמדינות מותרות וחלק אסורות. נסיעה ללא אישור מפורש עלולה לבטל את כל הביטוח. חובה לציין את היעד בעת ההזמנה ולקבל אישור בכתב מחברת ההשכרה.",
      },
    },
    {
      "@type": "Question",
      "name": "מה ההבדל בין Full-to-Full לבין Full-to-Empty בדלק?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Full-to-Full: מקבלים רכב עם מיכל מלא ומחזירים עם מיכל מלא. זו המדיניות השקופה ביותר. משלמים רק על מה שהשתמשת. אם מחזירים לא מלא, חברת ההשכרה ממלאת ומחייבת במחיר גבוה משמעותית מהשוק. Full-to-Empty: משלמים מראש על מיכל מלא ומחזירים ריק. נוח אבל יקר יותר.",
      },
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "לרוב יש חלון גרייס של 29 עד 59 דקות. אחרי זה מחויבים ביום שלם נוסף. אחרי שעה עד שעתיים מחלק מהחברות מחייבים יום וחצי. המדיניות משתנה בין חברות. חשוב לבדוק את תנאי החברה הספציפית ולתכנן זמן מאגר לפני ההחזרה.",
      },
    },
    {
      "@type": "Question",
      "name": "מה זה One-Way Fee בהשכרת רכב?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "One-Way Fee היא עמלה שגובות חברות ההשכרה כשמחזירים את הרכב בתחנה שונה מזו שבה אספו אותו. גובה העמלה משתנה לפי מרחק, מדינה וחברה. יכול להיות מכמה עשרות עד מאות אירו. חשוב לבדוק את עלות ה-One-Way לפני ההזמנה.",
      },
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "מה ההבדל בין קילומטרז׳ בלתי מוגבל לבין מוגבל?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Unlimited Mileage: אפשר לנסוע כמה קילומטרים שרוצים ללא תוספת עלות. Limited Mileage: יש תקרה יומית (לרוב 150 עד 300 ק״מ), ומעבר לה משלמים 0.10 עד 0.30 אירו לכל קילומטר נוסף. באירופה רוב ההזמנות כוללות קילומטראז׳ בלתי מוגבל. חשוב לבדוק לפני חתימה, במיוחד בטיולים ארוכים.",
      },
    },
    {
      "@type": "Question",
            ...
            <div>
              {[
                ...
                },
                {
                  ...
                  a: "חברת ההשכרה חוסמת סכום על כרטיס האשראי שלך (בין 300 ל-3,000 אירו בהתאם לרכב ולביטוח) כבטוחה לנזקים אפשריים. הסכום לא נגבה, רק מוחזק. הוא משוחרר לאחר החזרת הרכב תקין, בדרך כלל תוך 7–21 ימים. נדרש כרטיס אשראי ולא דביט.",
                },
                {
                  q: "מה ההבדל בין CDW ל-SCDW?",
                  a: "CDW הוא ביטוח נזק בסיסי שמגיע עם רוב הרכבים, אך מגיע עם השתתפות עצמית גבוהה (500–3,000 אירו). SCDW מוריד את ההשתתפות העצמית לאפס. בלי SCDW, כל נזק, גם קטן, יכול לעלות אלפי אירו.",
                },
                {
                  q: "האם ביטוח כרטיס אשראי מספיק לרכב שכור?",
                  a: "חלק מכרטיסי פרמיום מספקים כיסוי משלים, אך התנאים מוגבלים מאוד. הכיסוי לרוב משני (פועל רק אחרי CDW), לא כולל גנבה בכל המקרים, ויש הגבלות על סוג הרכב ומשך ההשכרה. חובה לקרוא את תנאי הכרטיס הספציפי לפני שסומכים עליו.",
                },
                {
                  q: "כמה עולה תוספת נהג צעיר?",
                  a: "נהגים מתחת לגיל 25 מחויבים בתוספת יומית של 10–25 אירו ליום. התוספת מחושבת על כל ימי ההשכרה ומשולמת בדלפק, לא בהזמנה המקוונת. על 10 ימים מדובר ב-100 עד 250 אירו נוספים.",
                },
                {
                  q: "האם מותר לנסוע עם רכב שכור מארץ לארץ?",
                  a: "תלוי בחוזה ובחברת ההשכרה. ברוב ההשכרות יש הגבלות על חציית גבולות. נסיעה ללא אישור מפורש עלולה לבטל את כל הביטוח. חובה לציין את היעד בעת ההזמנה ולקבל אישור בכתב.",
                },
                {
                  q: "מה ההבדל בין Full-to-Full לבין Full-to-Empty בדלק?",
                  a: "Full-to-Full: מקבלים רכב מלא ומחזירים מלא. הכי שקוף. אם מחזירים לא מלא, חברת ההשכרה ממלאת ומחייבת במחיר גבוה. Full-to-Empty: משלמים מראש על מיכל מלא ומחזירים ריק. נוח אבל יקר יותר.",
                },
                {
                  q: "מה קורה אם מחזירים רכב באיחור?",
                  a: "לרוב יש גרייס של 29–59 דקות. אחרי זה מחויבים ביום שלם נוסף. אחרי שעה עד שעתיים חלק מהחברות מחייבות יום וחצי. חשוב לבדוק את מדיניות החברה הספציפית ולתכנן זמן מאגר.",
                },
                {
                  q: "מה זה One-Way Fee?",
                  a: "עמלה שגובות חברות ההשכרה כשמחזירים את הרכב בתחנה שונה מזו שבה אספו אותו. גובה העמלה משתנה לפי מרחק, מדינה וחברה. יכול להגיע מכמה עשרות עד מאות אירו. חשוב לבדוק לפני ההזמנה.",
                },
                {
                ...
                {
                  q: "מה ההבדל בין קילומטרז׳ בלתי מוגבל לבין מוגבל?",
                  a: "Unlimited Mileage: נסיעה ללא הגבלה. Limited Mileage: תקרה יומית (150–300 ק״מ), ומעבר לה משלמים 0.10–0.30 אירו לכל קילומטר. באירופה רוב ההזמנות כוללות קילומטראז׳ בלתי מוגבל.",
                },
                {
