...
const docs = [
  ...
  },
  {
    ...
    icon: "📘",
    title: "דרכון",
    items: ["אצלך, לא במלון", "בזמן איסוף הרכב", "גם אם כבר נכנסת למדינה"],
    text: "אם אתה אוסף את הרכב ישר מהשדה תעופה אחרי הנחיתה, ברור שהדרכון אצלך. אבל יש מצב שאתה מגיע ליעד, מבלה כמה ימים, ורק אז הולך לאסוף רכב בעיר. שם בדיוק אנשים שוכחים. הדרכון נשאר בכספת המלון, ובדלפק מבקשים אותו. ולמה מבקשים? כי כתייר קיבלת מחיר בהתאם. הספק רוצה לוודא שאתה אכן תייר ולא תושב מקומי. ההוכחה לכך, חותמת הכניסה למדינה, נמצאת בדרכון. בלי דרכון, אין אימות. אין אימות, אין רכב. תיקח אותו.",
  },
  {
    id: "card",
    icon: "💳",
    title: "כרטיס אשראי",
    items: ["על שם הנהג הראשי", "לא דביט, לא כרטיס נטען", "לחסימת פיקדון בלבד"],
    text: "הכרטיס חייב להיות על שם הנהג הראשי, לא על שם בן הזוג או חבר שהשלים תשלום. הספק חוסם פיקדון על הכרטיס הזה. אם השם לא תואם, אין עסקה. דביט ופרה-פייד לא מתקבלים, גם אם הבנק שלך קורא להם \"כרטיס אשראי\". ועוד נקודה שאנשים לא בודקים: לא כל כרטיס מתקבל. יש ספקים שלא מקבלים דיינרס, יש כאלה שלא מקבלים אמריקן אקספרס. ויזה ומאסטרקארד הם הבטוחים. לפני שנוסעים, תיכנס לתנאי ההזמנה של הספק ותוודא איזה כרטיסים הם מקבלים. זה כתוב שם. רוב האנשים לא קוראים את זה.",
  },
];
