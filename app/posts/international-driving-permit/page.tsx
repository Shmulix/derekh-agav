        ...
        <div className="max-w-6xl mx-auto px-4 py-10 md:py-14">
          <div className="lg:grid lg:grid-cols-[220px_1fr_190px] lg:gap-10 items-start">
            ...
            <article className="min-w-0">
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-5">
                רוב יעדי הנסיעה הנפוצים לישראלים חתומים על אחת האמנות הבינלאומיות שמכירות ברישיון הבינלאומי. המצב הרשמי ברור. הבעיה היא שה"רשמי" וה"בפועל" לא תמיד מסתדרים.
              </p>
                ...
                <table className="w-full text-sm border-collapse">
                  <thead>
                    <tr className="bg-navy text-white">
                      <th className="text-right px-4 py-3 font-semibold rounded-tr-lg">יעד</th>
                      <th className="text-right px-4 py-3 font-semibold rounded-tl-lg">מה לצפות בפועל</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
                      { dest: "ארה״ב", note: "רוב חברות ההשכרה דורשות IDP לרישיון שאינו באנגלית. לא לבוא בלעדיו." },
                      { dest: "קנדה", note: "IDP מוכר ומקובל בכל מחוז." },
                      { dest: "צרפת, גרמניה, ספרד", note: "IDP נדרש רשמית. נאכף באופן לא עקבי, אבל ראיתי מקרים בכולן." },
                      { dest: "איטליה", note: "ההסכם הדו-צדדי שהיה עם ישראל בוטל. IDP נדרש. חברות ההשכרה מיישמות את זה." },
                      { dest: "יוון", note: "IDP נאכף בפועל לעיתים קרובות, במיוחד באיים." },
                      { dest: "פורטוגל", note: "IDP מוכר ומומלץ לכל השכרה." },
                      { dest: "טורקיה", note: "IDP מוכר. מומלץ לכל השכרה ללא יוצא מן הכלל." },
                      { dest: "תאילנד", note: "IDP חובה ונאכף בקפידה. בלי IDP אין רכב." },
                      { dest: "יפן", note: "ראה סעיף ייעודי. IDP תקף שנה בלבד מיום ההנפקה." },
                      { dest: "דובאי ואיחוד האמירויות", note: "חברות ההשכרה דורשות IDP מישראלים בפועל." },
                    ].map((row, i) => (
                      <tr key={i} className={i % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                        <td className="px-4 py-3 font-semibold text-navy border-b border-gray-100 whitespace-nowrap">{row.dest}</td>
                        <td className="px-4 py-3 text-gray-600 border-b border-gray-100 leading-relaxed">{row.note}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <div className="border border-amber-300 bg-amber-50 rounded-xl p-5 mb-8">
                <div className="flex items-start gap-3">
                  <AlertTriangle size={18} className="text-amber-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="font-bold text-amber-900 mb-2">הטבלה מציגה את המצב הרשמי. בדלפק זה לא תמיד עובד ככה.</p>
                    <p className="text-sm text-amber-800 leading-relaxed">
                      ארה״ב, גרמניה, צרפת, ספרד. עשיתי שכירויות בכולן, שמעתי על מקרים של דרישת IDP בכולן, גם כשרשמית לא היה צורך. הפקיד שעומד מולך עובד לפי הנוהל הפנימי שלו, לא לפי הרשימה שקראת. אין לך שליטה על זה. יש לך שליטה על זה שתבוא עם IDP.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <script
                ...
                dangerouslySetInnerHTML={{ __html: JSON.stringify({
                  ...
                  "mainEntity": [
                    ...
                    { "@type": "Question", "name": "האם צריך רישיון נהיגה בינלאומי בארה״ב?", "acceptedAnswer": { "@type": "Answer", "text": "כן. ארה״ב חתומה על אמנת 1949 ומכירה ברישיון הבינלאומי. בפועל, רוב חברות ההשכרה דורשות IDP מנהגים עם רישיון שאינו בשפה אנגלית. לא לבוא לדלפק בלי IDP." } },
                    { "@type": "Question", "name": "האם צריך רישיון נהיגה בינלאומי באיטליה?", "acceptedAnswer": { "@type": "Answer", "text": "כן. ההסכם הדו-צדדי שהיה בין ישראל לאיטליה בוטל. IDP נדרש, וחברות ההשכרה באיטליה מיישמות זאת." } },
                    { "@type": "Question", "name": "האם צריך רישיון נהיגה בינלאומי בתאילנד?", "acceptedAnswer": { "@type": "Answer", "text": "כן, וזה נאכף בקפידה. חברות ההשכרה בתאילנד דורשות IDP ללא פשרות. בלי IDP אין רכב." } },
                    { "@type": "Question", "name": "האם צריך רישיון נהיגה בינלאומי בדובאי?", "acceptedAnswer": { "@type": "Answer", "text": "בפועל כן. חברות ההשכרה באיחוד האמירויות דורשות IDP מישראלים. ייתכן שרשמית יש הסכם כלשהו, אבל בדלפק לא תמיד מחילים אותו. IDP מבטל את כל הספקות האלה." } },
                  ]
                })}}
              />
              <div className="space-y-3 mb-10">
                {[
                  ...
                  { q: "האם צריך רישיון נהיגה בינלאומי בארה״ב?", a: "כן. ארה״ב מכירה ברישיון הבינלאומי ורוב חברות ההשכרה דורשות אותו מנהגים עם רישיון שאינו בשפה אנגלית. לא לבוא לדלפק בלי IDP." },
                  { q: "האם צריך רישיון נהיגה בינלאומי באיטליה?", a: "כן. ההסכם הדו-צדדי שהיה בין ישראל לאיטליה בוטל. IDP נדרש, וחברות ההשכרה באיטליה מיישמות זאת." },
                  { q: "האם צריך רישיון נהיגה בינלאומי בתאילנד?", a: "כן, וזה נאכף בקפידה. חברות ההשכרה בתאילנד דורשות IDP ללא פשרות. בלי IDP אין רכב." },
                  { q: "האם צריך רישיון נהיגה בינלאומי בדובאי?", a: "בפועל כן. חברות ההשכרה באיחוד האמירויות דורשות IDP מישראלים. ייתכן שרשמית יש הסכם כלשהו, אבל בדלפק לא תמיד מחילים אותו. IDP מבטל את כל הספקות האלה." },
                ].map((item, i) => (
