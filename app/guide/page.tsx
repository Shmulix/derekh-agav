            ...
            <div>
              {[
                ...
                },
                {
                  ...
                  a: "לרוב חברות ההשכרה מאפשרות זמן חסד (grace period) לפני שמתחיל חיוב נוסף. משך זמן החסד משתנה לפי חברת ההשכרה ומפורט בתנאי ההזמנה, כדאי לבדוק לפני. מעבר לזמן החסד, התחנה תחייב יום שהייה נוסף לפי התעריף היומי שלה, ולפעמים גם קנס נוסף בנוסף לכך.",
                },
                {
                  q: "מה זה One-Way Fee?",
