...
const mobileTocItems = [
  { id: "what-is-idp", label: "מה זה IDP?" },
  ...
  { id: "how-to-get", label: "איך מוציאים IDP" },
          ...
          <div className="lg:grid lg:grid-cols-[220px_1fr_190px] lg:gap-10 items-start">
              ...
              <div className="sticky top-24 space-y-5">
                ...
                <div>
                  ...
                  <nav className="space-y-1">
                    {[
                      { href: "#what-is-idp", label: "מה זה IDP?" },
                      ...
                      { href: "#how-to-get", label: "איך מוציאים IDP" },
            ...
            <article className="min-w-0">
              ...
              <p className="text-lg text-gray-800 leading-relaxed mb-5">
                אם קראת כבר על הרישיון הישראלי בחו״ל, טוב מאוד. אבל יש מקרים שבהם הרישיון הישראלי שלך, גם אם הוא תקין לגמרי, לא שווה כלום בלי המסמך שהולך לידו.
                המסמך הזה הוא ה-IDP, רישיון הנהיגה הבינלאומי, והוא לא אופציה.
              </p>
              <p className="text-base text-gray-700 leading-relaxed mb-4">
                הבעיה היא שרוב הישראלים לא יודעים שהוא קיים. או שהם יודעים, אבל שמעו שאף אחד לא מבקש אותו.
                אז הם נוסעים בלעדיו. ורוב הפעמים? עובד. עד שזה לא עובד.
              </p>
              <p className="text-base text-gray-700 leading-relaxed mb-8">
                המאמר הזה יסביר מה זה IDP, למה הוא חובה לפי החוק הבינלאומי, למה הדלפק לא תמיד מבקש, ואיך מוציאים אותו בישראל תוך כמה דקות.
              </p>
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-4">
                ...
                זה לא רישיון עצמאי ולא מחליף את הרישיון הישראלי. זה תרגום רשמי של הרישיון שלך לשפות מרובות, מוכר בינלאומית, ומאפשר לרשויות ולחברות השכרה בכל מקום בעולם לאמת את פרטי הנהג, גם אם הם לא קוראים עברית.
              </p>
              <p className="text-base text-gray-700 leading-relaxed mb-4">
                הבסיס המשפטי שלו הוא אמנת וינה משנת 1968, אמנה בינלאומית שחתמו עליה עשרות מדינות, לפיה כל נהג שנוהג מחוץ למדינתו חייב לשאת IDP יחד עם הרישיון המקומי שלו.
                ישראל חתומה על האמנה. כלומר, לפי הדין הבינלאומי, כל ישראלי שנוהג בחו״ל חייב להחזיק IDP. לא מומלץ. חייב.
              </p>
              ...
              <div className="flex items-start gap-4 border border-navy/20 bg-[#f0f4ff] rounded-xl p-5 mb-8">
                ...
                <div>
                  <p className="font-bold text-navy mb-1">IDP תמיד יחד עם הרישיון הישראלי</p>
                  <p className="text-sm text-gray-700 leading-relaxed">
                    ה-IDP לא תקף לבד. הוא חייב להיות מוצג תמיד יחד עם הרישיון הישראלי המקורי, הפלסטיק הפיזי בתוקף.
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-5">
                הרבה ישראלים חושבים שכי יש להם רישיון באנגלית, הם פטורים מ-IDP. הם מגיעים לדלפק התחנה בביטחון, ואז מגלים שהפקיד מחפש גם מסמך נוסף.
              ...
              <div className="border border-amber-200 bg-amber-50 rounded-xl p-5 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-bold text-amber-800 mb-1">הרישיון הישראלי תקין. IDP הוא מסמך אחר לגמרי.</p>
                    <p className="text-sm text-amber-700 leading-relaxed">
                      עמידה בתקן אירופאי אומרת שהפורמט סטנדרטי ומוכר לקריאה. היא לא אומרת שהרישיון הישראלי מחליף את ה-IDP. שני מסמכים שונים עם שתי מטרות שונות.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-4">
                הרבה אנשים שכרו רכב חמש פעמים ולא התבקשו פעם אחת להציג IDP. הם מסיקים שהוא לא נחוץ. זו הסקה לא נכונה.
              </p>
              <p className="text-base text-gray-700 leading-relaxed mb-5">
              ...
              <div className="bg-navy rounded-xl p-6 mb-8">
                ...
                <p className="text-slate-300 text-sm leading-relaxed text-center">
                  ...
                  אותו עיקרון חל על IDP. לא נבדקת עשר פעמים? טוב לך. הפעם האחת עשרה שבה יבדקו, ואין לך? הרכב לא יוצא.
                </p>
              </div>

              <p className="text-base text-gray-700 leading-relaxed mb-8">
                ועוד משהו חשוב: הדלפק הוא לא הנקודה היחידה שבה IDP יכול להידרש.
              ...
              <h2 id="when-required" className="text-xl md:text-2xl font-bold text-navy mb-4 scroll-mt-24">
                כשה-IDP כן נדרש בפועל
              </h2>
              <p className="text-base text-gray-700 leading-relaxed mb-5">
                גם אם עברת את דלפק התחנה בלי בעיה, זה לא גמר. יש שני מצבים שבהם היעדר IDP יכול לעלות לך בהרבה.
              </p>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="border border-red-200 bg-red-50 rounded-xl p-5">
                  ...
                  <p className="text-sm text-red-700 leading-relaxed">
                    שוטר מקומי יכול לבקש IDP בכל רגע. בלי IDP? אתה חשוף לקנס, ובמקרים מסוימים לעיכוב. לא כי אתה פושע, כי פורמלית אתה נוהג בלי המסמכים הנדרשים לפי החוק המקומי.
                  </p>
                </div>
                ...
                <div className="border border-red-200 bg-red-50 rounded-xl p-5">
                  ...
                  <p className="text-sm text-red-700 leading-relaxed">
                    ...
                    הכסף שחסכת על IDP של 10 שקל יכול לעלות לך בכמה אלפי אירו.
                  </p>
                </div>
              ...
              <div className="flex items-start gap-4 border border-navy/20 bg-[#f0f4ff] rounded-xl p-5 mb-8">
                <Info size={20} className="text-navy flex-shrink-0 mt-0.5" />
                <p className="text-sm text-gray-700 leading-relaxed">
                  IDP לא מבטיח שהביטוח יכסה הכל. אבל בלי IDP, חברת הביטוח יכולה להשתמש בזה כעילה לסירוב. עם IDP, אפשרות הסירוב הזו לא קיימת.
                </p>
              </div>
              ...
              <div className="space-y-3 mb-6">
                {[
                  { num: "1", title: "מגיעים לתחנת צילום מורשית", text: "רק בתחנות מורשות מטעם משרד התחבורה. החברות המורשות הן אופטיקה הלפרין ומרמנת. לא ניתן להוציא IDP בדואר, בטלפון, או על ידי מיופה כוח." },
              ...
              >
                המידע הרשמי על הוצאת IDP באתר gov.il
                <ExternalLink size={14} />
              </a>
              ...
              <div className="border border-amber-200 bg-amber-50 rounded-xl p-5 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-700 leading-relaxed">
                      IDP מוציאים רק בישראל, לפני הנסיעה. אם שכחת ונזכרת בשדה התעופה, כבר מאוחר. תזמן את זה לפני שאתה עוזב.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-5">
                ה-IDP הוא חוברת קטנה בפורמט A6. הכריכה מודפסת במספר שפות, כולל את שם המדינה המנפיקה.
                בפנים: תמונת הנהג, הפרטים האישיים, ודרגת הרישיון, כולל תרגום לשפות בינלאומיות מרובות.
              </p>
              ...
              <p className="text-xs text-gray-400 text-center mb-8">דוגמה לרישיון נהיגה בינלאומי ישראלי (IDP)</p>
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-4">
                ה-IDP בתוקף לשלוש שנים מיום ההנפקה, או עד שפג תוקף הרישיון הישראלי, לפי המוקדם מביניהם.
              </p>
              <p className="text-base text-gray-700 leading-relaxed mb-4">
                מה זה אומר בפועל: אם הרישיון הישראלי שלך פג בעוד שנה, ה-IDP שתוציא היום יהיה בתוקף שנה בלבד, לא שלוש.
              ...
              <div className="border border-gray-200 rounded-xl p-5 bg-surface mb-8">
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">תוקף מקסימלי של IDP</p>
                  </div>
                  <div>
