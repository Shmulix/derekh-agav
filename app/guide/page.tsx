  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "חמישה דברים: (1) רישיון נהיגה ישראלי פיזי בפלסטיק בתוקף. (2) רישיון נהיגה בינלאומי פיזי בתוקף. (3) כרטיס אשראי בינלאומי פיזי עם מסגרת פנויה לפיקדון, קוד סודי, ולפחות 6 חודשי תוקף. (4) דרכון בתוקף. (5) כרטיס עלייה למטוס — לפעמים תבקש התחנה לראות אותו. כל המסמכים חייבים לשאת את אותו השם שמופיע בהזמנה, וכולם חייבים להיות מונפקים מאותה מדינה. שם שונה, מסמכים ממדינות שונות, או מסמך ממדינה אחרת? אין רכב.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "One-Way Fee היא עמלה שגובות חברות ההשכרה כשמחזירים את הרכב בתחנה שונה מזו שבה אספו אותו. גובה העמלה משתנה לפי מרחק, מדינה וחברה — מכמה עשרות עד מאות אירו. חשוב לבדוק את עלות ה-One-Way לפני ההזמנה.",
      },
    },
    {
      "@type": "Question",
              ...
              {[
                {
                  ...
                  a: "חמישה דברים שצריך להביא: (1) רישיון נהיגה ישראלי פיזי בפלסטיק, בתוקף. (2) רישיון נהיגה בינלאומי פיזי, בתוקף. (3) כרטיס אשראי בינלאומי פיזי עם מסגרת פנויה מספקת לפיקדון, עם קוד סודי, ועם לפחות 6 חודשי תוקף. (4) דרכון בתוקף. (5) לפעמים תבקש התחנה לראות גם כרטיס עלייה למטוס. שני דברים קריטיים: כל המסמכים חייבים לשאת את אותו השם שמופיע בהזמנה, וכולם חייבים להיות מונפקים מאותה מדינה. שם שונה, מסמכים ממדינות שונות, או מסמך ממדינה אחרת? אין רכב.",
                },
                {
                ...
                {
                  q: "מה זה One-Way Fee?",
                  a: "עמלה שגובות חברות ההשכרה כשמחזירים את הרכב בתחנה שונה מזו שבה אספו אותו. גובה העמלה משתנה לפי מרחק, מדינה וחברה — מכמה עשרות עד מאות אירו. חשוב לבדוק לפני ההזמנה.",
                },
                {
