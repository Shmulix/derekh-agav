  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "רישיון נהיגה ישראלי בתוקף, דרכון בתוקף, וכרטיס אשראי בינלאומי על שמך. בחלק מהיעדים (ארה״ב, קנדה, אוסטרליה, יפן, תאילנד ועוד) נדרש גם רישיון נהיגה בינלאומי. בלי כרטיס אשראי פיזי על שמך לא תקבל רכב.",
      },
    },
    {
      "@type": "Question",
              ...
              {[
                {
                  ...
                  a: "רישיון נהיגה ישראלי בתוקף, דרכון בתוקף, וכרטיס אשראי בינלאומי על שמך. בחלק מהיעדים (ארה״ב, קנדה, אוסטרליה, יפן, תאילנד ועוד) נדרש גם רישיון נהיגה בינלאומי. בלי כרטיס אשראי פיזי על שמך — לא תקבל רכב.",
                },
                {
