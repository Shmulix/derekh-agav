          ...
          <article className="flex-1 min-w-0">
            ...
            <div id="intro" className="mb-2 scroll-mt-24">
              ...
              <p className="text-gray-800 text-lg font-semibold leading-relaxed mb-5">
                שש שעות טיסה, מזוודות על הגב, כולם עייפים. ואז פקיד בדלפק שואל שאלה אחת שלא ציפית לה. ואתה לא יודע מה לענות.
              </p>

              <p className="text-gray-700 leading-relaxed mb-4">
                זה קורה יותר ממה שחושבים. לא כי אנשים לא חכמים. כי אף אחד לא הסביר להם מראש איך זה עובד.
              </p>

              <p className="text-gray-700 leading-relaxed mb-4">
                רכב שכור בחו״ל זה אחד הדברים הכי טובים שאפשר לעשות בטיול. אתה קם בבוקר, אין לוח זמנים, אין תחנות. אתה פשוט יוצא. מגיע למקומות שהאוטובוס לא מכיר. עוצר כשבא לך.
              </p>

              <p className="text-gray-700 leading-relaxed mb-5">
                מי שמגיע מוכן? נהנה ממנה עד הסוף. מי שלא? עומד בדלפק ומשלם על זה.
              </p>

              <p className="text-gray-700 leading-relaxed mb-5">
                כתבתי את המדריך הזה כדי שתהיה מוכן. הכל כאן, בלי שטויות.
              </p>
