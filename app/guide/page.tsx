...
const faqJsonLd = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "ישנם שני סוגי אגרה: וינייטה (מדבקה שנרכשת מראש לגישה לרשת כבישים, נדרשת באוסטריה, שוויץ, צ׳כיה ועוד) וכביש אגרה ממוחשב (חיוב אוטומטי בקמרה). לכבישים ממוחשבים חברות ההשכרה מצמידות מכשיר Toll Pass ומחייבות תוספת שירות יומית. וינייטות לרוב כלולות ברכב.",
      },
    },
    {
      "@type": "Question",
          ...
          <article className="flex-1 min-w-0">
            ...
            <div id="intro" className="mb-2 scroll-mt-24">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                המדריך הזה מכסה את כל מה שצריך לדעת לפני שמשכירים רכב בחו״ל. מסמכים נדרשים, ביטוח, פיקדון, דלק, קנסות, חציית גבולות ועוד. כל נושא מוסבר בשפה פשוטה, בלי מינוח משפטי, בלי שיווק.
              </p>
                ...
                <div className="space-y-0">
                  {[
                    ...
                    },
                    {
                      ...
                      desc: "האופרציה היא הלב של כל ברוקר השכרת רכב. שם מחליטים על כל הזמנה: לאשר, לדחות, להתאים. הייתי בקשר ישיר ויומיומי עם חברות ההשכרה. לא כלקוח, כשותף עסקי. בתפקיד זה רכשתי הבנה עמוקה על המוצר ועל התהליכים בשוק השכרת הרכב שלא ניתן לרכוש בדרך אחרת. הבנתי איך חברות ההשכרה חושבות, מה מניע אותן, תחת אילו אילוצים הן פועלות ואיפה הגמישות שלהן מסתיימת.",
                    },
                    {
                      role: "מנהל מוקד",
                      desc: "ניהלתי צוות שטיפל בלקוחות כל יום ושמעתי תרחישים שלא הייתי מאמין שקורים בפועל. ופגשתי שוב ושוב את אותו פער: מה הלקוח חשב שהוא הזמין, לבין מה שהסכים עליו בחוזה. זה פער שמעצבן אותי עד היום.",
                    },
                    {
            ...
            <div className="hidden lg:block bg-navy rounded-none p-6 mb-10">
              ...
              <p className="text-slate-300 text-sm leading-relaxed">
                הטעות הכי נפוצה שראיתי? אנשים שהשכירו רכב בעבר ומניחים שהם יודעים את כל מה שנדרש לדעת. אז לא. תפתח את תנאי ההזמנה שלך, תקרא אותם מההתחלה עד הסוף (כן, עד הסוף! אתה משכיר רכב וזה עניין רציני), ותשתמש במדריך הזה כדי להבין מה שקראת. זו הצורה הנכונה להשתמש בו.
              </p>
            </div>
            ...
            <div className="bg-surface border border-[#e7e9f0] rounded-none p-5 mb-5 text-sm text-gray-700 leading-relaxed space-y-3">
              ...
              <p>
                הדבר הנכון לעשות: <strong className="text-navy">להצהיר על הנסיעה כבר בשלב ההזמנה</strong>. ברוב אתרי ההשוואה ואצל רוב חברות ההשכרה יש שדה ייעודי לכך. אם אין, פנה ישירות לחברת ההשכרה ותקבל אישור בכתב. ייתכן תשלום נוסף עבור ביטוח לנסיעה מחוץ לגבולות, הדבר משתנה בין חברות ההשכרה ויש לבדוק זאת בתנאי ההשכרה.
              </p>
            </div>
            ...
            <div>
              {[
                ...
                },
                {
                  ...
                  a: "ישנם שני סוגי אגרה: וינייטה (מדבקה לגישה לרשת כבישים, נדרשת באוסטריה, שוויץ, צ׳כיה ועוד) וכביש אגרה ממוחשב (חיוב אוטומטי בקמרה). לכבישים ממוחשבים חברות ההשכרה מצמידות מכשיר Toll Pass בתוספת עמלת שירות יומית.",
                },
                {
