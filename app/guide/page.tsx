...
const faqJsonLd = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "באירופה (EU) הרישיון הישראלי מספיק ברוב המדינות. ביעדים מחוץ לאירופה כמו ארה״ב, קנדה, יפן, תאילנד ואוסטרליה — רישיון בינלאומי הוא חובה. גם אם לא חובה חוקית — מומלץ תמיד לקחת, כי חברות ההשכרה עלולות לדרוש אותו.",
      },
    },
    {
      "@type": "Question",
            ...
            <div>
              {[
                ...
                },
                {
                  ...
                  a: "באירופה (EU) הרישיון הישראלי מספיק ברוב המדינות. ביעדים מחוץ לאירופה כמו ארה״ב, קנדה, יפן, תאילנד ואוסטרליה — רישיון בינלאומי הוא חובה. גם אם לא חובה חוקית — מומלץ תמיד לקחת.",
                },
                {
