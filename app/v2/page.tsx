...
const pillars = [
  { k: "מידע", title: "מידע, לא מכירות", text: "האתר לא מנסה למכור לך כלום. הוא פה כדי שתגיע לדלפק עם ידע, לא עם הפתעות." },
  { k: "הכל", title: "כל הנושאים", text: "ממסמכים לביטוח, מדלק לקנסות. כל מה שצריך לדעת לפני, במהלך ואחרי ההשכרה." },
  { k: "עצמאי", title: "בלי ניגוד עניינים", text: "הקישורים הם שותפויות עמלה, אבל ההמלצות נשארות עצמאיות ומקצועיות. תמיד." },
];
      ...
      <main>
        ...
        <section className="relative z-20 bg-[#0b1730]">
          ...
          <div className="relative max-w-6xl mx-auto px-6 pt-32 pb-20 md:pt-44 md:pb-28">
            ...
            {/* Manifest row (data layer in mono) */}
            <Reveal delay={440}>
          ...
          <div className="max-w-6xl mx-auto px-6 py-24 md:py-32">
            <Reveal>
              <div className="flex items-end justify-between gap-4">
                ...
                <Link href="/v2/posts" className="hidden sm:inline-flex items-center gap-2 text-navy font-semibold text-sm hover:text-gold transition-colors">
