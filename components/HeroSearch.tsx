...
const searchableContent: SearchItem[] = [
  ...
  },
  {
    ...
    tags: ["ZTL", "איטליה", "Zona Traffico Limitato", "קנסות", "פירנצה", "רומא", "מילאנו", "פיזה", "ונציה", "בולוניה", "מצלמות", "מרכז היסטורי", "Centro Storico", "Area C"],
    type: "post",
    category: "יעדים",
    content: "ZTL הם אזורי תנועה מוגבלת במרכזי הערים ההיסטוריות באיטליה. ZTL ראשי תיבות של Zona Traffico Limitato, אזור תנועה מוגבלת. כניסה לאזור ZTL ברכב לא מורשה גוררת קנס אוטומטי בין 80 ל-335 אירו לכל כניסה. בנוסף חברת ההשכרה גובה עמלת טיפול של 30 עד 60 אירו. מצלמות אוטומטיות מצלמות את לוחית הרישוי. אין שום סימן פיזי שתפסו אתכם, אין פלאש, אין סירנה. הקנס מגיע חודשים אחרי הנסיעה. מעל 60% מהתיירים שמשכירים רכב באיטליה נכנסים ל-ZTL בלי לדעת. הערים העיקריות עם ZTL: רומא, פירנצה, מילאנו, פיזה, ונציה, בולוניה. פירנצה היא הקפדנית ביותר. פיזה פעיל 24/7. מילאנו יש גם Area C אזור גודש שדורש תשלום. אם המלון נמצא בתוך אזור ZTL חייבים לשלוח את מספר לוחית הרישוי למלון לפני ההגעה כדי שירשמו אתכם ברשימה הלבנה Lista Bianca. שלום תוך 5 ימים מקבלת ההודעה מזכה בהנחה של 30%. הסכנה: כל כניסה היא קנס נפרד, נכנסתם ויצאתם זה שני קנסות. הפתרון הטוב ביותר הוא לחנות מחוץ למרכז ולהשתמש בתחבורה ציבורית. אל תתבלבלו בין ZTL לבין Zona Pedonale שאסור לכל רכב.",
  },
];
