...
const terms = [
  ...
  },
  {
    ...
    desc: "החזרת רכב כשהתחנה סגורה. בדרך כלל מפקידים את המפתח בתיבת מפתחות ייעודית. חשוב לבדוק מראש. חברת ההשכרה עשויה לשנות שעות איסוף או החזרה ולא להודיע.",
  },
  {
  ...
  },
  {
    ...
    he: "כיסאון לתינוק",
    desc: "כיסא בטיחות לתינוקות עד כ-13 ק\"ג, פונה לאחור בלבד. לא כל התחנות מצוידות בכיסא תואם לתינוקות מתחת לגיל שנה. חובה לאשר זמינות מול חברת ההשכרה לפני ההזמנה.",
  },
  {
    term: "Baby Seat",
  ...
  },
  {
    ...
    he: "מושב הגבהה",
    desc: "מושב הגבהה לילדים מעל כ-22 ק\"ג. אין שקת, הילד מאובטח עם חגורת הרכב. מגביה את הילד כך שהחגורה תפגע בנקודה הנכונה.",
  },
  {
    term: "Ski Rack",
    full: "Ski Rack / Roof Rack",
    he: "גגון סקי / מנשא גג",
    desc: "מנשא המותקן על גג הרכב לקיבוע סקיות, סנובורד או מטען גדול. ניתן לשכור מחברת ההשכרה. לא כל הרכבים מגיעים מוכנים לגגון. יש לבדוק זמינות ולהזמין מראש.",
  },
  {
    term: "Supplemental Coverage",
    full: "Supplemental / Third-Party Insurance / Additional Coverage",
    he: "כיסוי משלים",
    desc: "ביטוח שנרכש מחוץ לחברת ההשכרה, דרך ברוקר, סוכנות נסיעות או עצמאית. לא מונע חיוב אלא מחזיר כסף בדיעבד, תמיד עד לתקרה שנקבעה בפוליסה. קיימים שלושה סוגים: כיסוי השתתפות עצמית בלבד, כיסוי נזקים ייחודיים, וכיסוי משולב.",
  },
];
