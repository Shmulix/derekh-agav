...
const criteria = [
  {
    title: "מדיניות ביטול",
    text: "התנאים משתנים מאתר לאתר. רכב שאי אפשר לבטל בחינם הוא התחייבות, לא מציאה. ביטול חינם עד 48 שעות לפני שווה לפעמים יותר מהנחה של חמישה אחוז.",
  },
  {
...
const platforms = [
  ...
  },
  {
    ...
    good: "כשאתה מחפש זמינות כמעט בכל יעד, כולל תחנות קטנות.",
    watch: "מלאי ענק אומר גם פערים גדולים באיכות בין תחנה לתחנה. בדוק את הדירוג של התחנה הספציפית, לא רק את הפלטפורמה.",
  },
  {
    name: "Kayak",
    url: "https://www.kayak.com/cars",
    tagline: "מטא חיפוש: משווה את המשווים",
    good: "כשאתה רוצה מבט על של טווח המחירים בשוק תוך חצי דקה. נקודת פתיחה טובה לסקר שוק.",
    watch: "קייאק לא מוכר לך ישירות. הוא שולח אותך לאתר אחר שמשלים את ההזמנה. אחרי הקליק אתה במגרש של מישהו אחר, עם המדיניות והתמיכה שלו.",
  },
  {
    name: "AutoEurope",
    url: "https://www.autoeurope.com/",
    tagline: "ותיק, חזק באירופה, שירות אנושי",
    good: "כשאתה נוסע באירופה ורוצה מוקד אנושי שמרים טלפון. חזקים בעסקאות הכל כלול.",
          ...
          <div className="lg:grid lg:grid-cols-[220px_1fr_190px] lg:gap-10 items-start">
            ...
            <article className="min-w-0">
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-4">
                המחיר שאתה רואה בעמוד התוצאות הוא לא המחיר שתשלם בסוף. בדלפק מחכים לך פיקדון, ביטוח שמנסים למכור, מדיניות דלק, ולפעמים תוספות שלא ידעת עליהן. פלטפורמה זולה עם תנאים גרועים תעלה לך יותר מפלטפורמה יקרה במעט עם תנאים נקיים.
              </p>
