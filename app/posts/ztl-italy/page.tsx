...
const cities = [
  {
    name: "רומא",
    icon: "🏛️",
    desc: "העיר הכי מסובכת. כמה אזורי ZTL נפרדים, כל אחד בשכונה אחרת. Centro Storico הוא הקפדני ביותר. אזור Trastevere נפתח בערב ובסופ״ש.",
  ...
  },
  {
    name: "בולוניה",
    icon: "🏰",
    desc: "מרכז היסטורי סגור. וברחובות ימי הביניים הצרים ממילא אין לכם מה לחפש עם רכב.",
        ...
        <div className="max-w-6xl mx-auto px-4 py-10 md:py-14">
          <div className="lg:grid lg:grid-cols-[220px_1fr_190px] lg:gap-10 items-start">
            ...
            <article className="min-w-0">
              ...
              <div className="callout-warning mb-10">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-700 leading-relaxed">
                      תשלום תוך 5 ימים מקבלת ההודעה מזכה בהנחה של 30%. ואל תתעלמו מהקנס: הוא לא נעלם, והוא יכול לצוץ בכניסה הבאה שלכם למדינה.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-6">
                אין חוק אחיד בכל איטליה. כל עירייה מחליטה לעצמה מתי ואיפה ה-ZTL פעיל. הנה הערים העיקריות:
              </p>
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-5">
                זה מצב נפוץ: הזמנתם מלון מקסים במרכז ההיסטורי, ורק עכשיו גיליתם שהוא בתוך אזור ZTL. בלי פאניקה. יש פתרון, ובחינם.
              </p>
              ...
              <div className="callout-tip mb-6">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-700 leading-relaxed">
                      אם המלון שכח לרשום אתכם, או שהרישום נעשה באיחור, יש לכם 60 יום מקבלת הקנס לערער. צרפו את אישור ההזמנה במלון, את ההתכתבות עם הקבלה, וכל הוכחה שהייתם אורחים באותו לילה. אם מוכיחים שהייתם זכאים לפטור, העירייה בדרך כלל מבטלת את הקנס. הרישום ברשימה הלבנה יכול להיעשות גם רטרואקטיבית, אם המלון מוכן לשתף פעולה.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-4">
                ה-ZTL הוא לא מלכודת תיירים, גם אם ככה זה מרגיש כשהמכתב מגיע. זו מערכת ששומרת על ערים בנות מאות שנים, והיא עובדת. אבל מי שלא מכיר את הכללים, משלם עליהם.
              </p>
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-10">
                זהו. שלושה כללים פשוטים. תעקבו אחריהם, ואף מכתב לא יחכה לכם בתיבה חודשים אחרי שחזרתם. סעו בשקט.
              </p>
