...
export default function MobileFloatingCTA() {
  ...
  return (
    <div className="lg:hidden">
      ...
      {open && (
        <div className="fixed bottom-[5rem] right-4 z-[60] w-64 bg-gold rounded-2xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-150">
