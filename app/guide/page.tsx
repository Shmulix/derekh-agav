  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "חמישה דברים: (1) רישיון נהיגה ישראלי פיזי בפלסטיק בתוקף. (2) רישיון נהיגה בינלאומי פיזי בתוקף. (3) כרטיס אשראי בינלאומי פיזי עם מסגרת פנויה לפיקדון, קוד סודי, ולפחות 6 חודשי תוקף. (4) דרכון בתוקף. (5) כרטיס עלייה למטוס — לפעמים תבקש התחנה לראות אותו. כל המסמכים חייבים לשאת את אותו השם שמופיע בהזמנה, וכולם חייבים להיות מונפקים מאותה מדינה, כלומר ישראלים.",
      },
    },
    {
      "@type": "Question",
              ...
              {[
                {
                  ...
                  a: "חמישה דברים שצריך להביא: (1) רישיון נהיגה ישראלי פיזי בפלסטיק, בתוקף. (2) רישיון נהיגה בינלאומי פיזי, בתוקף. (3) כרטיס אשראי בינלאומי פיזי עם מסגרת פנויה מספקת לפיקדון, עם קוד סודי, ועם לפחות 6 חודשי תוקף. (4) דרכון בתוקף. (5) לפעמים תבקש התחנה לראות גם כרטיס עלייה למטוס. שני דברים קריטיים: כל המסמכים חייבים לשאת את אותו השם שמופיע בהזמנה, וכולם חייבים להיות מונפקים מאותה מדינה, כלומר ישראלים. שם שונה, או מסמך ממדינה אחרת? אין רכב.",
                },
                {
