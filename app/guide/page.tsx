...
const faqJsonLd = {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "האם צריך רישיון נהיגה בינלאומי להשכרת רכב בחו״ל?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "כן. רישיון ישראלי הוא מסמך מקומי — תקף בישראל, לא מחוצה לה. רישיון בינלאומי (IDP) הוא זה שמאשר נהיגה בחו״ל. לא כל תחנה בודקת אותו בפועל, אבל כשמבקשים — ואין — הרכב לא יינתן. לוקחים את שניהם ביחד, תמיד.",
      },
    },
    {
      "@type": "Question",
          ...
          <article className="flex-1 min-w-0">
            ...
            <div>
              {[
                ...
                {
                  q: "האם צריך רישיון נהיגה בינלאומי?",
                  a: "כן. רישיון ישראלי הוא מסמך מקומי — תקף בישראל, ולא נועד לנהיגה בחו״ל. רישיון בינלאומי (IDP) הוא זה שמאשר את הזכות לנהוג מחוץ למדינה. נכון שלא כל תחנה בודקת אותו בפועל, אבל כשמבקשים אותו ואין אותו — הרכב לא יינתן. זה קורה, ולא לעיתים נדירות. לוקחים את שניהם ביחד, תמיד.",
                },
                {
